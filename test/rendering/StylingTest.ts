...
import {
    ...
    type SolidLineStyle,
    type Style,
    type TextTechniqueStyle,
    type Theme,
    type Value,
    TextureCoordinateType
} from "@orbitforge/orbitforge-datasource-protocol";
import { FeaturesDataSource } from "@orbitforge/orbitforge-features-datasource";
import { type GeoBox, OrientedBox3, ProjectionType } from "@orbitforge/orbitforge-geoutils";
import {
    type LookAtParams,
    type MapAnchor,
    MapView,
    MapViewEventNames
} from "@orbitforge/orbitforge-mapview";
import { GeoJsonTiler } from "@orbitforge/orbitforge-mapview-decoder/index-worker";
import {
    type TestOptions,
    getPlatform,
    RenderingTestHelper,
    waitForEvent
} from "@orbitforge/orbitforge-test-utils";
import { getReferenceImageUrl } from "@orbitforge/orbitforge-test-utils/lib/rendering/ReferenceImageLocator";
import { getOptionValue } from "@orbitforge/orbitforge-utils";
import { VectorTileDecoder } from "@orbitforge/orbitforge-vectortile-datasource/index-worker";
...
function baseRenderingTest(
    ...
    const commonTestOptions = { module: "OrbitForge" };
...
describe("MapView Styling Test", function () {
    ...
    describe("point features", function () {
        ...
        function makePointTextTestCases(
            testCases: Record<string, TextTechniqueStyle["attr"]>,
        ...
        function makePointPoiTestCases(
            testCases: Record<string, PoiStyle["attr"]>,
            options?: Partial<GeoJsonMapViewRenderingTestOptions>
        ) {
            for (const testCase in testCases) {
        ...
        function makePointTestCases(
            testCases: Record<string, CirclesStyle["attr"]>,
            options?: Partial<GeoJsonMapViewRenderingTestOptions>
        ) {
            for (const testCase in testCases) {
    ...
    describe("line features", function () {
        ...
        function makeLineTestCase(
            testCases: Record<string, SolidLineStyle["attr"]>,
    ...
    describe("polygon features", function () {
        ...
        function makePolygonTestCases<T extends FillStyle | ExtrudedPolygonStyle>(
            ...
            testCases: Record<string, T["attr"]>,
            options?: Partial<GeoJsonMapViewRenderingTestOptions>
        ) {

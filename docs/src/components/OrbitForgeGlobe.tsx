...
const OrbitForgeGlobe = () => {
  ...
  useEffect(() => {
    ...
    // 查找 'OrbitForge' 部分，确保正确构建基础URL
    const orbitforgeIndex = pathParts.indexOf('OrbitForge');
    const baseUrl = window.location.origin + (orbitforgeIndex !== -1 ? pathParts.slice(0, orbitforgeIndex + 1).join('/') : '');
      ...
      <head>
        ...
        <script type="importmap">
        {
            "imports": { 
                ...
                "@orbitforge/OrbitForge": "${baseUrl}/OrbitForge.module.js"
            }
        }
        </script>
      </head>

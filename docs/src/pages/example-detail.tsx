...
import { CESIUM_ION_TOKEN } from "@orbitforge/orbitforge-examples/src/token-config";
...
export default function ExampleDetail() {
    ...
    useEffect(() => {
        ...
        if (config?.customFields?.copyright) {
            ...
            setCopyrightText(
                `Copyright © ${new Date().getFullYear()} OrbitForge. Built with Docusaurus.`
            );
        }
    }, [siteConfig]);
          ...
          <head>
            ...
            <script type="importmap">
            {
                "imports": { 
                    ...
                    "@orbitforge/OrbitForge": "https://unpkg.com/@orbitforge/OrbitForge@latest/dist/OrbitForge.module.js",

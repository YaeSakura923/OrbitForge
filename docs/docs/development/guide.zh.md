...
OrbitForge/
├── @orbitforge/                    # 核心模块目录
│   ├── orbitforge-terrain-datasource/     # 地形数据源模块
│   ├── orbitforge-mapview/               # 地图视图核心模块
│   ├── orbitforge-geoutils/              # 地理空间工具模块
│   ├── orbitforge-datasource-protocol/   # 数据源协议模块
│   ├── orbitforge-map-controls/          # 地图控件模块
│   ├── orbitforge-utils/                 # 工具模块
│   └── ...                           # 其他模块
├── docs/                        # 文档目录
├── scripts/                     # 构建和开发脚本
├── test/                        # 测试目录

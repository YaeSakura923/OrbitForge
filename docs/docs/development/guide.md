...
This guide will help you understand the development workflow of OrbitForge.
...
The OrbitForge project follows a monorepo structure:
...
1. Create a new directory under `@orbitforge/`
...
{
  "dependencies": {
    "@orbitforge/mapview": "workspace:*",
    "@orbitforge/terrain-datasource": "workspace:*"
  }
}
```
...
OrbitForge follows semantic versioning (SemVer):

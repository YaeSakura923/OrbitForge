...
This guide will introduce how to build the OrbitForge project source code.

## Build System Overview

OrbitForge uses a modern build toolchain:
...
pnpm --filter @orbitforge/orbitforge-mapview build
```
...
To build the main OrbitForge bundle:

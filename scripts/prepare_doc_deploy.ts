...
//This script prepares the documentation and OrbitForge website to be deployed to S3
...
if (isReleaseBranch) {
    ...
    const allPackages = glob.sync("@orbitforge/*/package.json");
    ...
    fetch("https://www.orbitforge.dev/releases.json")
        .then((res: Response) => {
            return res.json();
        })

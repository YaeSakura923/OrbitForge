...
import { ITranslucentLayerConfig, Style, type FlatTheme, type Theme } from "@orbitforge/orbitforge-datasource-protocol";
import {
    type GeoBox,
...
import { type IntersectParams } from "@orbitforge/orbitforge-mapview/IntersectParams";
...
interface TileExtraTheme {
     ...
     *
     * @see {@link @orbitforge/orbitforge-3dtile-datasource#B3DMBatchMaterial}
     */
...
/**
 * A DataSource implementation for rendering 3D Tiles datasets in orbitforge
 *
 * This class integrates the 3D Tiles renderer with orbitforge's MapView system,
 ...
 * - Integration with orbitforge's theme system for styling
...
export class TileRenderDataSource extends DataSource {
     ...
     *
     * This method integrates with orbitforge's theme system to support

...
import { type GeoBox, type Projection } from "@orbitforge/orbitforge-geoutils";
import { type MapView, MapViewEventNames } from "@orbitforge/orbitforge-mapview";
import { type ITilesRenderer } from "@orbitforge/orbitforge-mapview/ITilesRenderer";
...
/**
 * 3D Tiles renderer that integrates with orbitforge's MapView system
 *
 * This class extends the base Three.js TilesRenderer to provide integration
 * with orbitforge's MapView, including:

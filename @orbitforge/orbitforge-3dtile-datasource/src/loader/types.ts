...
import type { FeatureTableJson, GLTFPostprocessed } from "@orbitforge/orbitforge-gltf";
 ...
 */
export interface Tiles3DTilesetJSON {
    shape: "tileset3d";
 ...
 */
export interface Tiles3DTileJSON {
...
/** Metadata about the tile's content and a link to the content. */
export interface Tiles3DTileContentJSON {
 ...
 */
export interface Tile3DBoundingVolume {
...
export interface Tiles3DTileContent {
    shape: "tile3d";
    ...
    featureTableJson?:
        ...
        | Record<string, any>;
    featureTableBinary?: Uint8Array;
    batchTableJson?: Record<string, Array<string | number>>;
...
export interface GLTFStyleBuffer {
    name: string;
    uri?: string;
    byteLength: number;
}
...
/** Subtree buffer view */
export interface GLTFStyleBufferView {
    buffer: number;
    byteOffset: number;
    byteLength: number;
}

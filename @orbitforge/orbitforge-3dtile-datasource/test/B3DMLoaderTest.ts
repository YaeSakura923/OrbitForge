...
import { OrientedBox3 } from "@orbitforge/orbitforge-geoutils";
...
describe("OrbitForge3DTileRendererTest", function () {
    ...
    //     let res = await fetch(
    //         "http://192.168.1.18/orbitforge-examples/data/UHV-transmission-lines/3dtile/16/54188/25560/data/6-153.b3dm"
    //     );
    ...
    //     let res = await fetch(
    //         "@orbitforge/orbitforge-3dtile-render/test/data/pipe/16/54067/25734/data/0-3.i3dm"
    //     );
    ...
    //     let b3DMLoader = new B3DMLoader(tilesLoadingManager);
    //     let res = await fetch(
    //         "http://192.168.1.18/orbitforge-examples/data/Zhoucun/3dtile_power/16/54218/25546/data/1-0.b3dm"
    //     );

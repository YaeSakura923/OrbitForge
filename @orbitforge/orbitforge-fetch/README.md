# @orbitforge/orbitforge-fetch

##Overview

This module adds a subset of the [fetch](https://orbitforge-fetch.spec.whatwg.org/) API for [Node.js](https://nodejs.org/). This allows code written for the browser to also execute in `Node.js`.

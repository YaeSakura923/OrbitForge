...
// URL is available globally in Node.js, no need to import from 'url' module
// import { URL } from "url";
 ...
 *
 * `@orbitforge/orbitforge-fetch` exposes this function as `global.fetch` in the Node.js environment, so it

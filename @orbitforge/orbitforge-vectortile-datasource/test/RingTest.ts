...
describe("Ring", function () {
    ...
    describe("Full quad outer ring", () => {
        ...
        it("with texture coordinates", () => {
            ...
            assert.deepEqual(
                ring.toArray(),
                [0, 0, 0, 0, 100, 0, 1, 0, 100, 100, 1, 1, 0, 100, 0, 1, 0, 0, 0, 0]
            );
        });
    });
    ...
    describe("Full quad inner ring", () => {
        ...
        it("with texture coordinates", () => {
            ...
            assert.deepEqual(
                ring.toArray(),
                [0, 0, 0, 0, 0, 100, 0, 1, 100, 100, 1, 1, 100, 0, 1, 0, 0, 0, 0, 0]
            );
        });
        ...
        it("flatten to array at a specific offset", () => {
            const ring = new Ring(points, undefined, DEFAULT_EXTENTS);
            assert.deepEqual(
                ring.toArray([123, 321], 2),
                [123, 321, 0, 0, 0, 100, 100, 100, 100, 0, 0, 0]
            );
        });

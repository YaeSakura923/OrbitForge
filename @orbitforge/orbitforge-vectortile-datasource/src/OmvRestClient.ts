...
import * as nodefetch from "@orbitforge/orbitforge-fetch";
import { type TileKey, type TilingScheme } from "@orbitforge/orbitforge-geoutils";
import { DataProvider } from "@orbitforge/orbitforge-mapview-decoder";
import { type ITransferManager, TransferManager } from "@orbitforge/orbitforge-transfer-manager";
...
export interface OmvRestClientParameters {
     ...
     *  - `{z}` - zoom level of tile, @see {@link @orbitforge/orbitforge-geoutils#TileKey.level}
     *  - `{x}` - horizontal coordinate of tile (column number),
     *            see {@link @orbitforge/orbitforge-geoutils#TileKey.column}
     *  - `{y}` - vertical coordinate of Tile (row number),
     *            see {@link @orbitforge/orbitforge-geoutils#TileKey.row}
     *
...
export class OmvRestClient extends DataProvider {
    ...
    private readonly urlParams: Record<string, string>;

...
import { type TileKey, EarthConstants, webMercatorTilingScheme } from "@orbitforge/orbitforge-geoutils";
import { type DataSourceOptions, DataSource, Tile } from "@orbitforge/orbitforge-mapview";
import {
    type DataProvider,
...
import {
    type FeatureModifierId,
    type OmvDecoderOptions,
    type OmvFeatureFilterDescription,
...
export interface VectorTileFactory {
    /** Create an instance of {@link @orbitforge/orbitforge-mapview#Tile} or a subclass. */
...
export interface VectorTileDataSourceParameters
    ...
    /**
     * Optional, custom factory for {@link @orbitforge/orbitforge-mapview#Tile} instances created

...
import { TilerService, WorkerServiceManager } from "@orbitforge/orbitforge-mapview-decoder/index-worker";
...
export class GeoJsonTilerService {
     ...
     * {@link @orbitforge/orbitforge-mapview-decoder#WorkerServiceManager}.
     *
     * @remarks

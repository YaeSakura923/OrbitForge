...
import { type StyleSetEvaluator, MapEnv } from "@orbitforge/orbitforge-datasource-protocol/index-decoder";
import { type AttrEvaluationContext } from "@orbitforge/orbitforge-datasource-protocol/TechniqueAttr";
import { type Projection, type TileKey } from "@orbitforge/orbitforge-geoutils";
import {
    ThemedTileDecoder,
    TileDecoderService,
    WorkerServiceManager
} from "@orbitforge/orbitforge-mapview-decoder/index-worker";
import { assert, LoggerManager, PerformanceTimer } from "@orbitforge/orbitforge-utils";
...
import { type OmvDecoderOptions, VECTOR_TILE_DECODER_SERVICE_TYPE } from "./OmvDecoderDefs";
import { type VectorTileDataEmitterOptions, VectorTileDataEmitter } from "./VectorTileDataEmitter";
...
export class VectorTileDecoder extends ThemedTileDecoder {
    ...
    private readonly m_options: { map: OptionsMap; changed: boolean } = { map: {}, changed: false };

...
import {
    ...
    type IMeshBuffers,
    type Value
} from "@orbitforge/orbitforge-datasource-protocol/index-decoder";
import {
    type AttrEvaluationContext,
    evaluateTechniqueAttr
} from "@orbitforge/orbitforge-datasource-protocol/TechniqueAttr";
import { clipPolygon } from "@orbitforge/orbitforge-geometry/ClipPolygon";
import {
    EdgeLengthGeometrySubdivisionModifier,
    SubdivisionMode
} from "@orbitforge/orbitforge-geometry/EdgeLengthGeometrySubdivisionModifier";
import { SphericalGeometrySubdivisionModifier } from "@orbitforge/orbitforge-geometry/SphericalGeometrySubdivisionModifier";
import {
    type Vector3Like,
    GeoBox,
    GeoCoordinates,
...
import { LineGroup } from "@orbitforge/orbitforge-lines/Lines";
import { triangulateLine } from "@orbitforge/orbitforge-lines/TriangulateLines";
import { ExtrusionFeatureDefs } from "@orbitforge/orbitforge-materials/MapMeshMaterialsDefs";
import { assert, getOptionValue, LoggerManager, Math2D } from "@orbitforge/orbitforge-utils";
...
export class VectorTileDataEmitter {
    ...
    constructor(
        ...
        private readonly m_styleSetEvaluator: StyleSetEvaluator = new StyleSetEvaluator({
            styleSet: []
        }),

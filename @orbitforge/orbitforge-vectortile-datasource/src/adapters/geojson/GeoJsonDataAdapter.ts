...
import { type ValueMap } from "@orbitforge/orbitforge-datasource-protocol/Env";
import { clipLineString } from "@orbitforge/orbitforge-geometry/ClipLineString";
import {
    type GeoPointLike,
    GeoCoordinates,
    webMercatorProjection
} from "@orbitforge/orbitforge-geoutils";
import { type Vector2Like } from "@orbitforge/orbitforge-geoutils/math/Vector2Like";
...
function convertLineStringGeometry(coordinates: GeoPointLike[], decodeInfo: DecodeInfo): any {

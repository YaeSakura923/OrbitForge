...
import { type GeometryKind, GeometryKindSet } from "@orbitforge/orbitforge-datasource-protocol";
import { type MapEnv } from "@orbitforge/orbitforge-datasource-protocol/index-decoder";

import {
    type OmvFeatureFilterDescription,
    type OmvFilterDescription,
    type OmvFilterFeatureAttribute,
    type OmvGeometryType,
    type OmvLayerFilterDescription,
    OmvFilterString
} from "./OmvDecoderDefs";
...
export interface OmvFeatureFilter {
     ...
     * @deprecated See {@link @orbitforge/orbitforge-datasource-protocol/BaseTechniqueParams.kind}.
     */

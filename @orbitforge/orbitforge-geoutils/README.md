# @orbitforge/orbitforge-geoutils
...
```bash
pnpm install @orbitforge/orbitforge-geoutils
```
...
import { GeoLineStringToStrip } from "@orbitforge/orbitforge-geoutils";
...
```typescript
import { GeoCoordinates } from "@orbitforge/orbitforge-geoutils";
import { GeoLineStringToStrip, IProjection } from "@orbitforge/orbitforge-geoutils";

...
export namespace TileKeyUtils {
     ...
     *
     * @param tileKey - The unique {@link @orbitforge/orbitforge-geoutils#TileKey}
     *                  from which to compute the unique key.
     * @param offset - How much the given {@link @orbitforge/orbitforge-geoutils#TileKey} is offset

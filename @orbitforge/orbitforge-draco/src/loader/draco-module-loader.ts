...
import { loadLibrary } from "@orbitforge/orbitforge-utils";
...
async function loadDracoDecoder(options: DracoLoaderOptions) {
    ...
    switch (options.draco && options.draco.decoderType) {
        case "js":
            DracoDecoderModule = await loadLibrary(
                DRACO_EXTERNAL_LIBRARY_URLS_[DRACO_EXTERNAL_LIBRARIES.FALLBACK_DECODER],
                "draco",
                options,
        ...
        default:
            [DracoDecoderModule, wasmBinary] = await Promise.all([
                await loadLibrary(
                    DRACO_EXTERNAL_LIBRARY_URLS_[DRACO_EXTERNAL_LIBRARIES.DECODER],
                    "draco",
                    options,
                    DRACO_EXTERNAL_LIBRARIES.DECODER
                ),
                await loadLibrary(
                    DRACO_EXTERNAL_LIBRARY_URLS_[DRACO_EXTERNAL_LIBRARIES.DECODER_WASM],
                    "draco",
                    options,

...
export default class DracoBuilder {
    ...
    _getAttributesFromMesh(mesh: DracoMesh) {
        // Extract attributes from Three.js geometry
        const attributes: { [key: string]: THREE.BufferAttribute } = {};

        // Iterate through all geometry attributes
        mesh.geometry.attributes = mesh.geometry.attributes || {};
        ...
        if (mesh.geometry.index) {
            attributes.indices = new THREE.BufferAttribute(
    ...
    _addAttributeToMesh(
        ...
        switch (attribute.constructor) {
            case Int8Array:
                return builder.AddInt8Attribute(
                    mesh,
                    type,
                    vertexCount,
                    size,
            ...
            case Int16Array:
                return builder.AddInt16Attribute(
                    mesh,
                    type,
                    vertexCount,
                    size,
            ...
            case Int32Array:
                return builder.AddInt32Attribute(
                    mesh,
                    type,
                    vertexCount,
                    size,
            ...
            case Uint8ClampedArray:
                return builder.AddUInt8Attribute(
                    mesh,
                    type,
                    vertexCount,
                    size,
            ...
            case Uint16Array:
                return builder.AddUInt16Attribute(
                    mesh,
                    type,
                    vertexCount,
                    size,
            ...
            case Uint32Array:
                return builder.AddUInt32Attribute(
                    mesh,
                    type,
                    vertexCount,
                    size,
            ...
            case Float32Array:
                return builder.AddFloatAttribute(
                    mesh,
                    type,
                    vertexCount,
                    size,

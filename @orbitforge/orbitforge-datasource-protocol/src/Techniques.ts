...
import { type Expr, type JsonExpr } from "./Expr";
...
import { type StylePriority } from "./Theme";
...
export interface Tile3DTechnique extends MakeTechniqueAttrs<Tile3DBatchMeshTechniqueParams> {
    name: "tile3d";
}
...
export function isTile3DTechnique(technique: Technique): technique is Tile3DTechnique {
    return technique.name === "tile3d";
}

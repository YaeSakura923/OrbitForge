...
import { type JsonExpr } from "./Expr";
...
export interface MarkerTechniqueParams extends BaseTechniqueParams {
     ...
     * cached in {@link @orbitforge/orbitforge-mapview#userImageCache} to be rendered as marker.
     */
...
export type ShaderTechniqueMaterialParameters = Record<string, any>;

/**
 * Special technique for user-defined shaders. See
 * https://threejs.org/docs/#api/orbitforge-materials/ShaderMaterial for details.
 */
...
export interface TransitionValue<T> {
    from: T;
    to: T;
}
/**
 * Technique parameters for 3D Tiles batch mesh rendering.
 */
export interface Tile3DBatchMeshTechniqueParams extends BaseTechniqueParams {
    /**
     * Specified kind of geometry.
     *
     * @remarks
     ...
     */
    color?: StyleColor | TransitionValue<StyleColor>;

    /**
     * Opacity of the mesh.
     */
    opacity?: number | TransitionValue<number>;

    /**
     * Metalness of the mesh.
     */
    metalness?: number | TransitionValue<number>;

    /**
     * Roughness of the mesh.
     */
    roughness?: number | TransitionValue<number>;

    /**
     * Emissive color of the mesh.
     */
    emissive?: StyleColor | TransitionValue<StyleColor>;
    ...
    /**
     * Offset value for the mesh.
     */
    offset?: number | TransitionValue<number>;

    /**
     * Direction of the offset.
     */
    direction?: DynamicProperty<"radial" | "up" | "down">;

    /**
     * Current numerical value representing the state or progress
     * Typically ranges from 0.0 to 1.0 for normalized values
     */
    value?: number;
}

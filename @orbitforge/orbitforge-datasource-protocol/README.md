...
## How to Style a Map? - Overview of [orbitforge](https://github.com/orbitforge)'s Map Styling
...
An example theme file used in orbitforge-examples could be found in the
[tilezen_base.json](../orbitforge-map-theme/resources/tilezen_base.json).

...
import { type TileKey, type TilingScheme } from "@orbitforge/orbitforge-geoutils";
import {
    type CopyrightInfo,
...
import { ThemeLoader } from "@orbitforge/orbitforge-mapview/ThemeLoader";
import { type ILogger, LoggerManager } from "@orbitforge/orbitforge-utils";
 ...
 */
export interface TileDataSourceOptions<Provider extends DataProvider = DataProvider>
...
export class TileDataSource<
    ...
    Provider extends DataProvider = DataProvider
> extends DataSource {
    ...
    constructor(
        ...
        private readonly m_options: TileDataSourceOptions<Provider>
    ) {
        super(m_options);
     ...
     *
     * Applies new {@orbitforge/orbitforge-datasource-protocol StyleSet} and definitions from theme only
    ...
    protected setDataProvider(value: Provider) {
        this.m_options.dataProvider = value;
    }
    ...
    setTilingScheme(value: TilingScheme) {
        this.m_options.tilingScheme = value;
    }

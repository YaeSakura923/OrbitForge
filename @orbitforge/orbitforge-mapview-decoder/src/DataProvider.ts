 ...
 */
export abstract class DataProvider<TileData = ArrayBufferLike> extends EventDispatcher<
    Record<string, any>
> {
    private readonly m_clients = new Set<Object>();
    ...
    /**
     * Load the data of a {@link @orbitforge/orbitforge-mapview@Tile} asynchronously.
     *
     * @param tileKey - Address of a tile.
     * @param abortSignal - Optional AbortSignal to cancel the request.
     * @returns A promise delivering the data as an [[ArrayBufferLike]], or any object.
     */
    abstract getTile(tileKey: TileKey, abortSignal?: AbortSignal): Promise<TileData | {}>;

...
import { type DataSource, BaseTileLoader } from "@orbitforge/orbitforge-mapview";
import { TileLoaderState } from "@orbitforge/orbitforge-mapview/ITileLoader";
 ...
 * the [[TileDataSource]].
 */
export class TileLoader<DataSourceType extends DataSource = DataSource> extends BaseTileLoader {
    /**
     ...
     */
    constructor(
        protected dataSource: DataSourceType,

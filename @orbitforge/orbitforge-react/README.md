# @orbitforge/orbitforge-react

React wrapper for orbitforge MapView with context provider.

## Overview

This package provides React components and hooks for integrating orbitforge MapView into React applications. It includes:
...
```bash
npm install @orbitforge/orbitforge-react @orbitforge/orbitforge-mapview @orbitforge/orbitforge-map-controls
# or
yarn add @orbitforge/orbitforge-react @orbitforge/orbitforge-mapview @orbitforge/orbitforge-map-controls
# or
pnpm add @orbitforge/orbitforge-react @orbitforge/orbitforge-mapview @orbitforge/orbitforge-map-controls
```
...
import { MapProvider, MapCanvas, useMap } from '@orbitforge/orbitforge-react';
...
### Basic Example
```tsx
import { BasicReactExample } from '@orbitforge/orbitforge-react';
...
```tsx
import { AdvancedReactExample } from '@orbitforge/orbitforge-react';
...
import { 
  ...
  useMapCamera,
  useDataSource 
} from '@orbitforge/orbitforge-react';
import { VectorTileDataSource } from '@orbitforge/orbitforge-vectortile-datasource';

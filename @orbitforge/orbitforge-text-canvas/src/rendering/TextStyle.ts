...
export class TextRenderStyle {
     ...
     */
    copy(source: TextRenderStyle): this {
...
export class TextLayoutStyle {
    ...
    constructor(params: TextLayoutParameters = {}) {
        ...
        const placementResult = resolvePlacementAndAlignment(
        ...
        this.m_params = {
            ...
            verticalAlignment: placementResult.verticalAlignment,
            horizontalAlignment: placementResult.horizontalAlignment,
    ...
    set placements(value: TextPlacements) {
        ...
        this.m_params.horizontalAlignment = placementResult.horizontalAlignment;
        this.m_params.verticalAlignment = placementResult.verticalAlignment;
        this.m_params.placements = placementResult.placements;
    }
     ...
     * @returns reference to `this` object.
     */
    copy(other: TextLayoutStyle): this {

...
// @orbitforge:check-imports:environment:node
 ...
 *
 * @param moduleName -: module name, `@orbitforge/<module_name>` (e.g. @orbitforge/orbitforge-vectortile-datasource)
 ...
 * purposes:
 *  * `@orbitforge/${module}/test/resources`
 *  * `@orbitforge/${module}/resources`
 *
 ...
 *
 * @param module -: module name, @orbitforge/<module_name> (e.g. @orbitforge/orbitforge-vectortile-datasource)
 * @param fileName -: the requested resource
 *                  (e.g. @orbitforge/orbitforge-vectortile-datasource/test/resources/berlin.bin)
 */

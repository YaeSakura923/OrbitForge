# @orbitforge/orbitforge-map-theme

## Overview

This module contains the themes used by `orbitforge`.
...
The [style](resources/tilezen_base.json) is called `berlin`, inspired by the vibrant city of [Berlin](https://en.wikipedia.org/wiki/Berlin), where most of the development of `orbitforge` is done.

...
class GLTFV1Normalizer {
    ...
    _addAsset(json) {
        ...
        json.asset.generator = json.asset.generator || "Normalized to glTF 2.0 by orbitforge";
    }
    ...
    _convertMeshIds(mesh) {
        for (const primitive of mesh.primitives) {
            ...
            for (const attributeName in attributes) {
                attributes[attributeName] = this._convertIdToIndex(
...
export function normalizeGLTFV1(gltf, options = {}) {
    new GLTFV1Normalizer().normalize(gltf, options);
}

...
import type { BigTypedArray, TypedArray } from "@orbitforge/orbitforge-utils";
...
import type {
    GLTF,
    GLTFMeshPrimitive,
    GLTFTextureInfoMetadata
} from "../../types/gltf-json-schema";
import {
    type NumericComponentType,
...
function findPropertyTableByClass(
    propertyTables: Record<string, GLTF_EXT_feature_metadata_FeatureTable>,
...
function handleFeatureTextureProperties(
    ...
    for (const propertyName in schemaClass.properties) {
        ...
        if (featureTextureProperty) {
            const data = getPropertyDataFromTexture(
                scenegraph,

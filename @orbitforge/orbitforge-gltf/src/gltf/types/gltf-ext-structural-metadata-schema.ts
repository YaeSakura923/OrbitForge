 ...
 */
export interface GLTF_EXT_structural_metadata_GLTF {
 ...
 */
export interface GLTF_EXT_structural_metadata_Schema {
    ...
    classes?: Record<string, GLTF_EXT_structural_metadata_Class>;
    /** A dictionary, where each key is an enum ID and each value is an object defining the values for the enum. */
    enums?: Record<string, GLTF_EXT_structural_metadata_Enum>;
 ...
 */
export interface GLTF_EXT_structural_metadata_Enum {
 ...
 */
export interface GLTF_EXT_structural_metadata_EnumValue {
 ...
 */
export interface GLTF_EXT_structural_metadata_Class {
     ...
     */
    properties: Record<string, GLTF_EXT_structural_metadata_ClassProperty>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_structural_metadata_ClassProperty {
 ...
 */
export interface GLTF_EXT_structural_metadata_PropertyTable {
     ...
     */
    properties?: Record<string, GLTF_EXT_structural_metadata_PropertyTable_Property>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_structural_metadata_PropertyTable_Property {
    /**
 ...
 */
export interface GLTF_EXT_structural_metadata_PropertyTexture {
     ...
     */
    properties?: Record<string, GLTFTextureInfoMetadata>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_structural_metadata_PropertyAttribute {
 ...
 */
export interface GLTF_EXT_structural_metadata_Primitive {

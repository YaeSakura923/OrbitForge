...
import { type GLTFTextureInfo } from "./gltf-json-schema";
 ...
 */
export interface GLTF_EXT_feature_metadata_GLTF {
    ...
    featureTables?: Record<string, GLTF_EXT_feature_metadata_FeatureTable>;
    /** A dictionary, where each key is a feature texture ID and each value is an object defining the feature texture. */
    featureTextures?: Record<string, GLTF_EXT_feature_metadata_FeatureTexture>;
 ...
 */
export interface GLTF_EXT_feature_metadata_Schema {
    ...
    classes?: Record<string, GLTF_EXT_feature_metadata_Class>;
    /** A dictionary, where each key is an enum ID and each value is an object defining the values for the enum. */
    enums?: Record<string, GLTF_EXT_feature_metadata_Enum>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_feature_metadata_Class {
    /** The name of the class, e.g. for display purposes. */
    name?: string;
    /** The description of the class. */
    description?: string;
    /** A dictionary, where each key is a property ID and each value is an object defining the property. */
    properties: Record<string, GLTF_EXT_feature_metadata_ClassProperty>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_feature_metadata_ClassProperty {
 ...
 */
export interface GLTF_EXT_feature_metadata_Enum {
 ...
 */
export interface GLTF_EXT_feature_metadata_EnumValue {
 ...
 */
export interface GLTF_EXT_feature_metadata_FeatureTable {
     ...
     */
    properties?: Record<string, GLTF_EXT_feature_metadata_FeatureTableProperty>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_feature_metadata_FeatureTableProperty {
    /**
 ...
 */
export interface GLTF_EXT_feature_metadata_FeatureTexture {
     ...
     */
    properties: Record<string, GLTF_EXT_feature_metadata_TextureAccessor>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_feature_metadata_TextureAccessor {
 ...
 */
export interface GLTF_EXT_feature_metadata_Statistics {
    /**
     ...
     */
    classes?: Record<string, GLTF_EXT_feature_metadata_StatisticsClass>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_feature_metadata_StatisticsClass {
     ...
     */
    properties?: Record<string, GLTF_EXT_feature_metadata_StatisticsClassProperty>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 * JSON Schema - https://github.com/CesiumGS/glTF/blob/c38f7f37e894004353c15cd0481bc5b7381ce841/extensions/2.0/Vendor/EXT_feature_metadata/schema/statistics.class.property.schema.json
 */
export interface GLTF_EXT_feature_metadata_StatisticsClassProperty {
     ...
     * For fixed-length arrays, this is an array with componentCount number of elements.
     */
    occurrences: Record<string, number | number[]>;
    extensions?: Record<string, unknown>;
    extras?: unknown;
}
 ...
 */
export interface GLTF_EXT_feature_metadata_Primitive {
 ...
 */
export interface GLTF_EXT_feature_metadata_FeatureIdAttribute {
 ...
 */
export interface GLTF_EXT_feature_metadata_FeatureIdAttributeFeatureIds {
 ...
 */
export interface GLTF_EXT_feature_metadata_FeatureIdTexture {
 ...
 * JSON Schema - https://github.com/CesiumGS/glTF/blob/c38f7f37e894004353c15cd0481bc5b7381ce841/extensions/2.0/Vendor/EXT_feature_metadata/schema/textureAccessor.schema.json
 */
export interface GLTF_EXT_feature_metadata_FeatureIdTextureAccessor {

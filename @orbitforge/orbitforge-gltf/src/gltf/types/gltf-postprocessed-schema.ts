...
import type { TypedArray } from "@orbitforge/orbitforge-utils";
 ...
 */
export interface GLTFAccessorPostprocessed {
    id: string;
    components: number;
 ...
 */
export interface GLTFAnimationPostprocessed {
    id: string;
 ...
 */
export interface GLTFBufferPostprocessed {
    id?: string;
 ...
 */
export interface GLTFBufferViewPostprocessed {
    id: string;
    data: Uint8Array;
 ...
 */
export interface GLTFCameraPostprocessed {
    // GLTF attributes (possibly overridden)
    /**
     * An orthographic camera containing properties to create an orthographic projection matrix.
     */
 ...
 */
export interface GLTFImagePostprocessed {
    id: string;
    // TODO - extend
    image: {
        data: Uint8Array;
 ...
 */
export interface GLTFTextureInfoPostprocessed {
    id: string;
 ...
 */
export interface MaterialPbrMetallicRoughnessPostprocessed {
    id: string;
...
export interface MaterialNormalTextureInfoPostprocessed {
    id: string;
    texture: GLTFTexturePostprocessed;
...
export interface MaterialOcclusionTextureInfoPostprocessed {
    id: string;
    texture: GLTFTexturePostprocessed;
 ...
 */
export interface GLTFMaterialPostprocessed {
    id: string;
 ...
 */
export interface GLTFMeshPrimitivePostprocessed {
    // GLTF attributes (possibly overridden)
    /**
    ...
    targets?: Array<Record<string, GlTfId>>;
    extensions?: any;
    extras?: any;
    // [k: string]: any;
}
 ...
 */
export interface GLTFMeshPostprocessed {
    id: string;
 ...
 */
export interface GLTFNodePostprocessed {
    id: string;
 ...
 */
export interface GLTFSamplerPostprocessed {
    id: string;
    /** WebGL parameters */
 ...
 */
export interface GLTFScenePostprocessed {
    id: string;
 ...
 */
export interface GLTFSkinPostprocessed {
    id: string;
 ...
 */
export interface GLTFTexturePostprocessed {
    id: string;
 ...
 */
export interface GLTFPostprocessed {
    id: string;

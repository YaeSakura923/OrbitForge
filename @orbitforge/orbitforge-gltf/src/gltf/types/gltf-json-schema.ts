...
export interface GLTFMeshPrimitive {
     ...
     */
    attributes: Record<string, GLTFId>;
    /**
 ...
 */
export interface GLTF_KHR_binary_glTF {
    bufferView: number;
 ...
 */
export interface GLTF_KHR_draco_mesh_compression {
    bufferView: GLTFId;
 ...
 */
export interface GLTF_KHR_texture_basisu {
    source: GLTFId;
    extras?: any;
}
 ...
 */
export interface GLTF_EXT_meshopt_compression {
    buffer: number;
    byteOffset?: number;
    byteLength: number;
    byteStride: number;
 ...
 */
export interface GLTF_EXT_texture_webp {
    source: GLTFId;
    extras?: any;
}
 ...
 */
export interface GLTF_MSFT_texture_dds {
    source: GLTFId;
    extras?: any;
}

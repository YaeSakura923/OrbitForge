 ...
 */
export namespace TextStylingDynamicExample {
    ...
    function initDebugGrid() {
            ...
            new THREE.LineSegments(
                new THREE.WireframeGeometry(
                    new THREE.PlaneGeometry(
                        ...
                        Math.floor(window.innerHeight / 16)
                    )
                ),
        ...
        penObject = new THREE.Mesh(
            new THREE.SphereGeometry(
                CONFIG.SPHERE_GEOMETRY_RADIUS,
                CONFIG.SPHERE_GEOMETRY_WIDTH_SEGMENTS,
                CONFIG.SPHERE_GEOMETRY_HEIGHT_SEGMENTS
            ),
            new THREE.MeshBasicMaterial({ color: CONFIG.BOUNDS_COLOR })
        );
    ...
    function initDebugBounds() {
        ...
        boundsVertexBuffer = new THREE.BufferAttribute(
            new Float32Array(32 * 4 * CONFIG.CHARACTER_COUNT),
            4
        );

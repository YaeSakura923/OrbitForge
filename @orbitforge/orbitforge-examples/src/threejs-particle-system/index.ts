...
// Define extended control interface with dynamically added properties
interface ExtendedMapControls extends MapControls {
    autoExplosion?: boolean;
    explosionCount?: number;
}

// Initialize map controls
const controls: ExtendedMapControls = new MapControls(mapView);
...
class NebulaParticleManager extends THREE.Object3D {
    ...
    private renderer: SpriteRenderer | null = null;
    private clock: THREE.Clock;
    private currentEmitters: Emitter[] = [];
 ...
 */
const startAutoExplosion = (controls: ExtendedMapControls): void => {
    setInterval(() => {

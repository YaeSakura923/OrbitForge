import {
    ...
    sphereProjection, ModularMapViewMonitor,
    DEMTerrainSource,
    ArcGISTileProvider,
    MapViewEventNames,
    GUI
...
const PROJECT_CONFIG = {
    POWER_LINE_3DTILES_URL: "http://192.168.1.18/orbitforge-examples/data/%E7%89%B9%E9%AB%98%E5%8E%8B%E8%BE%93%E7%94%B5%E7%BA%BF%E8%B7%AF/3dtile/tileset.json",
    POWER_LINE_TERRAIN_URL: "http://192.168.1.18/orbitforge-examples/data/特高压输电线路/terrain/{z}/{x}/{y}.png",
    TERRAIN_BOUNDS: [117.45208740234376, 36.630958008194135, 117.86407470703126, 36.96086580957587] as [number, number, number, number]
};
 ...
 * @param mapView Map view instance
 */
const addPowerLineDataSource = (mapView: MapView): void => {

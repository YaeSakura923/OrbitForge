...
// 生成 INDEX.md 内容
let indexContent = `# orbitforge 示例目录

本目录包含 orbitforge 的所有示例，按照功能分类组织。
...
indexContent += `\n\n## 核心项目结构，书写代码请参考以下模块\n\n- [地图视图模块 (@orbitforge/orbitforge-mapview)](./@orbitforge/orbitforge-mapview/README.md) - 地图视图核心模块，负责地图的显示、交互和渲染调度\n- [地图控制器模块 (@orbitforge/orbitforge-map-controls)](./@orbitforge/orbitforge-map-controls/README.md) - 地图控制器模块，提供相机交互控制功能\n- [地形数据源模块 (@orbitforge/orbitforge-terrain-datasource)](./@orbitforge/orbitforge-terrain-datasource/README.md) - 地形数据源模块，处理地形数据的加载与解码\n- [绘制控件模块 (@orbitforge/orbitforge-draw-controls)](./@orbitforge/orbitforge-draw-controls/README.md) - 绘制控件模块，支持在地图上绘制几何图形\n`;

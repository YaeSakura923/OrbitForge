...
import { type MapMeshBasicMaterial } from "@orbitforge/orbitforge-materials";
...
import { type DisplacementMap } from "../src/DisplacementMap";
...
describe("TileGeometryCreator", () => {
    ...
    it("terrain tile gets tile displacement map as user data", () => {
        const decodedDisplacementMap: Record<string, unknown> = {
            xCountVertices: 2,
            yCountVertices: 3,

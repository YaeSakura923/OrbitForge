...
import { Env } from "@orbitforge/orbitforge-datasource-protocol";
import { getTestResourceUrl } from "@orbitforge/orbitforge-test-utils";
import {
...
import { getAppBaseUrl } from "@orbitforge/orbitforge-utils";
...
async function createTextCanvas(): Promise<TextCanvas> {
    let fontDir = getTestResourceUrl("@here/FLYWAVE-fontcatalog", "");
    if (inNodeContext) {
        fontDir = path.dirname(require.resolve("@here/FLYWAVE-fontcatalog/package.json"));
    }

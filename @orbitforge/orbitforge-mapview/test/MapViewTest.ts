...
import { Expr, getProjectionName } from "@orbitforge/orbitforge-datasource-protocol";
import {
...
import * as TestUtils from "@orbitforge/orbitforge-test-utils/WebGLStub";
...
import { TerrainDataSource, type DataSource } from "../src/DataSource";
import { type ElevationProvider } from "../src/ElevationProvider";
import { type ElevationRangeSource, CalculationStatus } from "../src/ElevationRangeSource";
import { MapMaterialAdapter } from "../src/MapMaterialAdapter";
import { MapObjectAdapter } from "../src/MapObjectAdapter";
import { type LookAtParams, type MapViewOptions, MapView, MapViewEventNames } from "../src/MapView";
...
describe("MapView", function () {
    ...
    it("#dispose removes event listeners", async function () {
        ...
        const eventStubs = new Map<string, sinon.SinonStub>();
    ...
    describe("elevation source", function () {
        let fakeElevationSource: TerrainDataSource;
        ...
        describe("setElevationSource", function () {
            ...
            it("can replace an elevation source", async function () {
                const secondElevationSource: TerrainDataSource = {
                    ...fakeElevationSource
                } as any;

...
import { getOptionValue, TaskQueue } from "@orbitforge/orbitforge-utils";
...
import { type MapView, TileTaskGroups } from "../src/MapView";
import { Tile } from "../src/Tile";
import {
    type DataSourceTileList,
...
describe("VisibleTileSet", function () {
    ...
    it("caches frustum intersection for data sources with same tiling scheme", async function () {
        ...
        sinon.replace(
            secondDataSource,
            "getTilingScheme",
            sinon.stub().returns(geographicStandardTiling)
        );

...
import { getTestResourceUrl, silenceLoggingAroundFunction } from "@orbitforge/orbitforge-test-utils";
import { LogLevel } from "@orbitforge/orbitforge-utils";
import { assert } from "chai";

import { type ImageItem } from "../src/image/Image";
...
describe("ImageCache", function () {
    ...
    if (typeof document !== "undefined") {
        ...
        image.src = getTestResourceUrl("@orbitforge/orbitforge-mapview", "test/resources/headshot.png");

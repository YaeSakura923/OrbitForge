...
import { TileKey } from "@orbitforge/orbitforge-geoutils";
                            ...
                            object: {
                                ...
                                userData: {
                                    ...
                                    feature: {
                                        geometryType: 7,
                                        starts: [
                                            0, 558, 690, 1329, 1704, 2169, 2448, 2778, 3282, 3726,
                                            3789, 3795, 3804, 3810, 3816, 3822, 3825, 4128, 4131,
                                            4383, 4797, 5031, 5223, 5370, 5523, 5550, 5658, 5688,
                                            5694
                                        ],
                                        objInfos: [
                            ...
                            object: {
                                ...
                                userData: {
                                    ...
                                    feature: {
                                        geometryType: 7,
                                        starts: [
                                            0, 378, 472, 904, 1160, 1476, 1668, 1894, 2234, 2536,
                                            2584, 2594, 2606, 2616, 2626, 2636, 2644, 2852, 2860,
                                            3034, 3316, 3478, 3612, 3712, 3828, 3848, 3922, 3948,
                                            3958
                                        ],
                                        objInfos: [
                                            { $id: "KLRKDk6pCr", name: "piemonte" },

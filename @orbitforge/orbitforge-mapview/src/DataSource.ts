...
import { type FlatTheme, type Theme, type ValueMap } from "@orbitforge/orbitforge-datasource-protocol";
import { ExprPool } from "@orbitforge/orbitforge-datasource-protocol/ExprPool";
import {
    type Projection,
    type TileKey,
    type TilingScheme
} from "@orbitforge/orbitforge-geoutils";
import { assert, LoggerManager } from "@orbitforge/orbitforge-utils";
...
export abstract class DataSource extends THREE.EventDispatcher<{ update: {} }> {
    ...
    /**
     * The {@link @orbitforge/orbitforge-geoutils#Projection} used by
     * the {@link MapView} that is holding this `DataSource`.
     *
    ...
    /**
     * Returns the {@link @orbitforge/orbitforge-geoutils#TilingScheme} used by this `DataSource`.
     */
    ...
    /**
     * Apply the {@link @orbitforge/orbitforge-datasource-protocol#Theme} to this data source.
     *
    ...
    async setThemeFromBase(theme: Theme | FlatTheme, languages?: string[]): Promise<void> {
        this.setTheme(theme);
    }
     ...
     * {@link @orbitforge/orbitforge-geoutils#TileKey}.
     *
     ...
     * given {@link @orbitforge/orbitforge-geoutils#TileKey} and zoom level.
     *
     * @param zoomLevel - The zoom level of the {@link MapView}.
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the tile for the given {@link @orbitforge/orbitforge-geoutils#TileKey} can be loaded.
     */
     ...
     * further with given {@link @orbitforge/orbitforge-geoutils#TileKey} and
     * zoom level.
     *
     * @param zoomLevel - The zoom level of the {@link MapView}.
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the subtiles of the given {@link @orbitforge/orbitforge-geoutils#TileKey} should be
    ...
    /**
     * Returns `true` if {@link MapView} should render the children
     * of the given {@link @orbitforge/orbitforge-geoutils#TileKey}.
     *
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the children of the given {@link @orbitforge/orbitforge-geoutils#TileKey} should be
     * checked for collisions.
     */
     ...
     * elements with the given {@link @orbitforge/orbitforge-geoutils#TileKey} and
     * zoom level.
     *
     * @remarks
     ...
     *          given {@link @orbitforge/orbitforge-geoutils#TileKey} should be rendered.
     */
...
export interface TerrainDataSource extends DataSource {
    /**
     * The elevation provider for this data source.
     */
    getElevationProvider(): ElevationProvider;

    /**
     * The elevation range source for this data source.
     */
    getElevationRangeSource(): ElevationRangeSource;
}

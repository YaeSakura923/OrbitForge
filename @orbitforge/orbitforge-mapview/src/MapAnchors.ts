...
import { type StylePriority } from "@orbitforge/orbitforge-datasource-protocol";
import {
    type GeoCoordinates,
    type Projection,
    type Vector3Like,
 ...
 * given {@link @orbitforge/orbitforge-geoutils#GeoCoordinates}.
 *
 * @remarkks
 * @example
 * Example:
...
export type MapAnchor<T extends THREE.Object3D = THREE.Object3D> = T & {
    /**
     * The position of this [[MapAnchor]] in {@link @orbitforge/orbitforge-geoutils#GeoCoordinates}.
     * @deprecated Use [[anchor]] instead.
     */
    geoPosition?: GeoCoordinates;

    /**
     * The anchor of this Object3D in {@link @orbitforge/orbitforge-geoutils#GeoCoordinates}
...
export class MapAnchors {
    private readonly m_anchors: MapAnchor[] = [];

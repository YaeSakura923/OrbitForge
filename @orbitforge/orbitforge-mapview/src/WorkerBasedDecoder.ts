...
import { type ConcurrentWorkerSet } from "./ConcurrentWorkerSet";
...
export class WorkerBasedDecoder implements ITileDecoder {
     ...
     *
     * @remarks
     * Invokes {@link @orbitforge/orbitforge-datasource-protocol#DecodeTileRequest} on
    ...
    /**
     * Get {@link @orbitforge/orbitforge-datasource-protocol#TileInfo} from tile decoder service in worker.
     *
     * @remarks
     * Invokes {@link @orbitforge/orbitforge-datasource-protocol#TileInfoRequest}
     ...
     *
     * @remarks
     * Broadcasts {@link @orbitforge/orbitforge-datasource-protocol#ConfigurationMessage}

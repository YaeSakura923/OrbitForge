...
import { type ImageItem, type TexturizableImage } from "./Image";
...
export class MapViewImageCache {
    private readonly m_name2Url = new Map<string, string>();
    private readonly m_urlNameCount = new Map<string, number>();

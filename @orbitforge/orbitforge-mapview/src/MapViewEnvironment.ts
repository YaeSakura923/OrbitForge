...
import { type GradientSky, type Light, type Sky } from "@orbitforge/orbitforge-datasource-protocol";
import { type Vector3Like, ProjectionType } from "@orbitforge/orbitforge-geoutils";
...
export class MapViewEnvironment {
    ...
    update() {
        this.m_fog.update(this.m_mapView, this.m_mapView.targetDistance);
        if (

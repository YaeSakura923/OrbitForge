...
import { LoggerManager, PerformanceTimer } from "@orbitforge/orbitforge-utils";
...
export class FrameStatsArray {
    readonly frameEntries = new Map<string, RingBuffer<number>>();
...
export class PerformanceStatistics {
     ...
     */
    readonly appResults = new Map<string, number>();
    ...
    getAsSimpleFrameStatistics(onlyLastFrame: boolean = false): SimpleFrameStatistics {
        ...
        const appResults = new Map<string, number>();

...
import { getUrlOrigin, LoggerManager } from "@orbitforge/orbitforge-utils";

import { type WorkerBootstrapResponse, isWorkerBootstrapRequest } from "./WorkerBootstrapDefs";
...
export class WorkerLoader {
    ...
    static dependencyUrlMapping: Record<string, string> = {};

...
import { type GeoBox } from "@orbitforge/orbitforge-geoutils";
import { type ILogger, getOptionValue, LoggerManager } from "@orbitforge/orbitforge-utils";

import { type CopyrightInfo } from "./CopyrightInfo";
import { type CopyrightProvider } from "./CopyrightProvider";
 ...
 * response.
 */
export type CopyrightCoverageResponse = Record<string, AreaCopyrightInfo[]>;

...
} from "@orbitforge/orbitforge-datasource-protocol/TechniqueDescriptors";
import {
 ...
 * {@link @orbitforge/orbitforge-datasource-protocol#BufferAttribute} object.
 *
 ...
 * @param env - {@link @orbitforge/orbitforge-datasource-protocol#Env} instance
 *              used to evaluate {@link @orbitforge/orbitforge-datasource-protocol#Expr}
...
function applyShaderTechniqueToMaterial(technique: ShaderTechnique, material: THREE.Material) {
    ...
    const params = technique.params as Record<string, any>;
 ...
 * @param env - {@link @orbitforge/orbitforge-datasource-protocol#Env} instance used
 *              to evaluate {@link @orbitforge/orbitforge-datasource-protocol#Expr}
 *              based properties of [[Technique]]
 */
 ...
 * @param env - {@link @orbitforge/orbitforge-datasource-protocol#Env} instance used to evaluate
 *              {@link @orbitforge/orbitforge-datasource-protocol#Expr} based properties of [[Technique]]
 *
 * @internal
 */

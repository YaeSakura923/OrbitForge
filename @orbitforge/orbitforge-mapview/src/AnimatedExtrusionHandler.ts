...
import { type ExtrusionFeature, ExtrusionFeatureDefs } from "@orbitforge/orbitforge-materials";
import { MathUtils } from "@orbitforge/orbitforge-utils";
...
export class AnimatedExtrusionHandler {
    ...
    private readonly m_dataSourceMap = new Map<DataSource, TileMap>();

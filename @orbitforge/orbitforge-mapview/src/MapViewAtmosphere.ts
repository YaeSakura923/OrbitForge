...
import { type Theme } from "@orbitforge/orbitforge-datasource-protocol";
import { type Projection, EarthConstants, ProjectionType } from "@orbitforge/orbitforge-geoutils";
import {
...
export class MapViewAtmosphere {
     ...
     * {@link @orbitforge/orbitforge-datasource-protocol#Theme} instance provided.
     *
     ...
     *
     * @param theme - A {@link @orbitforge/orbitforge-datasource-protocol#Theme} instance.
     */
    reset(theme: Theme) {

...
import { RequestController, WorkerServiceProtocol } from "@orbitforge/orbitforge-datasource-protocol";
import {
...
export class ConcurrentWorkerSet {
    ...
    private readonly m_requests = new Map<number, RequestEntry>();
    ...
    async connect(serviceId: string): Promise<void> {
        ...
        await this.getReadyPromise(serviceId).promise;
    }

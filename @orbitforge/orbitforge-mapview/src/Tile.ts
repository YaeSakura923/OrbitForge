...
import { type CachedResource, assert, chainCallbacks, LoggerManager } from "@orbitforge/orbitforge-utils";
...
import { type ITileLoader, TileLoaderState } from "./ITileLoader";
import { type MapView } from "./MapView";
import { type PathBlockingElement } from "./PathBlockingElement";
...
export class Tile implements CachedResource {
    ...
    private readonly m_ownedTextures = new WeakSet<THREE.Texture>();
    ...
    /**
     * The {@link @orbitforge/orbitforge-geoutils#Projection} currently used by the {@link MapView}.
     */
            ...
            .then(tileLoaderState => {
                ...
                decodedTile?.dependencies?.forEach(mortonCode => {
                    this.dependencies.push(
                        TileKey.fromMortonCode(
                            mortonCode,
                            this.dataSource.getTilingScheme().mortonTileEncoding
                        )
                    );
                });
            })
     ...
     * The {@link @orbitforge/orbitforge-datasource-protocol#DecodedTile} is still available.
     */
    ...
    private computeResourceInfo(): void {
        ...
        const visitedObjects = new Map<string, boolean>();

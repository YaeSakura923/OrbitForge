...
import { disableBlending, enableBlending, RawShaderMaterial } from "@orbitforge/orbitforge-materials";
 ...
 */
export type StyledProperties = Record<string, Expr | StylePropertyEvaluator | Value | undefined>;
...
export class MapMaterialAdapter {
     ...
     */
    readonly currentStyledProperties: Record<string, Value | undefined>;

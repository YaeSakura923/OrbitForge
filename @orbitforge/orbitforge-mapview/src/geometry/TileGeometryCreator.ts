...
import {
    ...
    type DecodedTile,
    type Env,
    type ExtrudedPolygonTechnique,
    type FillTechnique,
    type Geometry,
    type GeometryKindSet,
    type IndexedTechnique,
    type InterleavedBufferAttribute,
    type MakeTechniqueAttrs,
    type SolidLineTechnique,
    type StandardExtrudedLineTechnique,
    type Technique,
    type TerrainTechnique,
...
} from "@orbitforge/orbitforge-datasource-protocol/ExprEvaluator";
import { EarthConstants, ProjectionType } from "@orbitforge/orbitforge-geoutils";
import {
    type EdgeMaterialParameters,
    type ExtrusionFeature,
    type MapMeshStandardMaterial,
    type SolidLineMaterial,
    EdgeMaterial,
    FadingFeature,
    hasExtrusionFeature,
...
} from "@orbitforge/orbitforge-materials";
...
import { type DisplacementMap, type TileDisplacementMap } from "../DisplacementMap";
import { type MapAdapterUpdateEnv, MapMaterialAdapter } from "../MapMaterialAdapter";
import { type MapViewPoints } from "../MapViewPoints";
...
/**
 * Support class to create geometry for a {@link Tile} from a {@link @orbitforge/orbitforge-datasource-protocol#DecodedTile}.
 * @internal
 */
export class TileGeometryCreator {
     ...
     * @param decodedTile - The {@link @orbitforge/orbitforge-datasource-protocol#DecodedTile}.
     * @param textFilter -: Optional filter. Should return true for any text technique that is
     *      applicable.
     */
    createTextElements(
    ...
    /**
     * Gets the attachments of the given {@link @orbitforge/orbitforge-datasource-protocol#DecodedTile}.
     *
     * @param decodedTile - The {@link @orbitforge/orbitforge-datasource-protocol#DecodedTile}.
     */
    ...
    private addUserData(
        ...
        if (isTerrainTechnique(technique)) {
            ...
            const displacementMap = (srcGeometry.objInfos as unknown as DisplacementMap[])[0];

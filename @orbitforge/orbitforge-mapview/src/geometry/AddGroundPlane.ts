...
import { GeometryKind, Pickability } from "@orbitforge/orbitforge-datasource-protocol";
import {
...
import { type Projection, ProjectionType } from "@orbitforge/orbitforge-geoutils";
import { MapMeshBasicMaterial, MapMeshStandardMaterial } from "@orbitforge/orbitforge-materials";
...
function createGroundPlaneGeometry(
    ...
    if (receiveShadow) {
        ...
        const normAttr = copyVector3sArray(
            Array(4).fill(tmpV),

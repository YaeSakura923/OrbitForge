...
import { LoggerManager, Math2D } from "@orbitforge/orbitforge-utils";
...
export class CollisionBox extends Math2D.Box implements IBox {
    ...
    copy(box: Math2D.Box | THREE.Box2 | IBox): this {
...
export class ScreenCollisionsDebug extends ScreenCollisions {
    ...
    private readonly m_renderContext: CanvasRenderingContext2D | null = null;

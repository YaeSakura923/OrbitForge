...
import { type Projection, OrientedBox3, ProjectionType } from "@orbitforge/orbitforge-geoutils";
import {
...
import { assert, Math2D, MathUtils } from "@orbitforge/orbitforge-utils";
 ...
 * @param env - The {@link @orbitforge/orbitforge-datasource-protocol#Env} used
 ...
 * @param scale - Scale factor to be applied to label dimensions.
 * @param textCanvas - The text canvas where the label will be placed.
 * @param env - The {@link @orbitforge/orbitforge-datasource-protocol#Env}

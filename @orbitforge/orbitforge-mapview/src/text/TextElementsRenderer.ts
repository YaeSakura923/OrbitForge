...
import { type TileKey, type Vector3Like } from "@orbitforge/orbitforge-geoutils";
import {
    type AdditionParameters,
    type FontCatalog,
    type TextBufferAdditionParameters,
    type TextBufferCreationParameters,
    type TextCanvas,
...
import { type PickListener } from "../PickListener";
import { type PoiManager } from "../poi/PoiManager";
import { type PoiLayer, PoiRenderer } from "../poi/PoiRenderer";
import {
    type IBox,
    type LineWithBound,
    ScreenCollisions,
    ScreenCollisionsDebug
} from "../ScreenCollisions";
import { type ScreenProjector } from "../ScreenProjector";
import { type Tile } from "../Tile";
import { type MapViewUtils } from "../Utils";
import { type DataSourceTileList } from "../VisibleTileSet";
...
import { type TextElement, type TextPickResult, LoadingState } from "./TextElement";
import { type TextElementGroup } from "./TextElementGroup";
import { type TextElementFilter, type TextElementGroupState } from "./TextElementGroupState";
import {
    type TextElementsRendererOptions,
    initializeDefaultOptions
} from "./TextElementsRendererOptions";
import { type TextElementState } from "./TextElementState";
import { TextElementStateCache } from "./TextElementStateCache";
import { TextElementType } from "./TextElementType";
import { type TextElementStyle, TextStyleCache } from "./TextStyleCache";
...
export class TextElementsRenderer {
    ...
    private updateTextElementsFromSource(
        ...
        sortedTiles.sort((a: Tile, b: Tile) => {
            return (
                ...
                b.tileKey.mortonCode(tileDataSource.getTilingScheme().mortonTileEncoding)
            );
        });
    ...
    private createSortedGroupsForSorting(
        ...
        const groupedPriorityLists = new Map<number, TextElementLists>();

...
import { getOptionValue, LoggerManager } from "@orbitforge/orbitforge-utils";
import type * as THREE from "three";

import { ColorCache } from "../ColorCache";
import { evaluateColorProperty } from "../DecodedTileHelpers";
import { type Tile } from "../Tile";
import { type TextCanvases, DEFAULT_FONT_CATALOG_NAME } from "./TextElementsRenderer";
 ...
 * {@link @orbitforge/orbitforge-datasource-protocol#Theme}'s TextStyle.
 */
...
export class TextStyleCache {
    private readonly m_textStyles = new Map<string, TextElementStyle>();
    ...
    /**
     * Retrieves a {@link TextElementStyle} for {@link @orbitforge/orbitforge-datasource-protocol#Theme}'s
     * [[TextStyle]] id.
     */
    ...
    /**
     * Gets the appropriate {@link @orbitforge/orbitforge-text-canvas#TextRenderStyle}
    ...
    /**
     * Create the appropriate {@link @orbitforge/orbitforge-text-canvas#TextLayoutStyle}
     * to use for a label. Depends heavily on the label's
     * [[Technique]] and the current zoomLevel.
     *

...
export interface PoiInfo {
    ...
    /**
     * Name of the {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture} or image in
     * {@link @orbitforge/orbitforge-mapview#userImageCache}.
     */
     ...
     * Icon color override
     *
     * @see {@link @orbitforge/orbitforge-datasource-protocol#MarkerTechniqueParams.iconColor};
     */
     ...
     * Icon brightness.
     *
     * @see {@link @orbitforge/orbitforge-datasource-protocol#MarkerTechniqueParams.iconBrightness};
     */
    ...
    /**
     * @hidden
     * Direct access to {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture} once it is resolved.
     */
...
export class TextElement {
    ...
    /**
     * @hidden
     * Array storing the style {@link @orbitforge/orbitforge-text-canvas#GlyphData} for

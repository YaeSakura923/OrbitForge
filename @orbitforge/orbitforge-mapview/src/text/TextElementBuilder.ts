...
import {
    type TextLayoutStyle,
    type TextRenderStyle,
    ContextualArabicConverter
} from "@orbitforge/orbitforge-text-canvas";
import { assert, LoggerManager, MathUtils } from "@orbitforge/orbitforge-utils";
import type * as THREE from "three";

import { PoiBuilder } from "../poi/PoiBuilder";
import { TextElement } from "./TextElement";
import { DEFAULT_TEXT_DISTANCE_SCALE } from "./TextElementsRenderer";
import { type TileTextStyleCache } from "./TileTextStyleCache";

const logger = LoggerManager.instance.create("TextElementBuilder");

/**
 * Constructs {@link TextElement} objects from {@link @orbitforge/orbitforge-datasource-protocol/Technique},
...
export class TextElementBuilder {
     ...
     * Constructor
     *
     * @param m_env - The {@link @link @orbitforge/orbitforge-datasource-protocol#MapEnv} used to evaluate
     * technique properties.
     * @param m_styleCache - To cache instances of {@link @orbitforge/orbitforge-text-canvas/TextRenderStyle}
     * and {@link @orbitforge/orbitforge-text-canvas/TextLayoutStyle}.
     */
    constructor(
     ...
     *
     * @param technique - The {@link @orbitforge/orbitforge-datasource-protocol/Technique}.
     * @return This builder.
     */
    withTechnique(

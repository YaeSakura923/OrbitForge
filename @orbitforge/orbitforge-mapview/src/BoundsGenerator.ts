...
import { type GeoPolygon, type Projection, ProjectionType } from "@orbitforge/orbitforge-geoutils";
...
export class BoundsGenerator {
    ...
    /**
     * Generates a {@link @orbitforge/orbitforge-geoutils#GeoPolygon} covering the visible map.

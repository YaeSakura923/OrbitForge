...
import { IconMaterial } from "@orbitforge/orbitforge-materials";
import { type MemoryUsage } from "@orbitforge/orbitforge-text-canvas";
import { assert, LoggerManager, Math2D } from "@orbitforge/orbitforge-utils";
...
import { type ScreenCollisions } from "../ScreenCollisions";
import { type PoiInfo, type TextElement } from "../text/TextElement";
import { BoxBuffer } from "./BoxBuffer";
import { type PoiManager } from "./PoiManager";
 ...
 * ({@link @orbitforge/orbitforge-datasource-protocol#ImageTexture}).
 *
...
export class PoiBatchRegistry {
    private readonly m_batchMap = new Map<string, PoiBatch>();
...
// threshold.
const missingTextureName = new Map<string, number>();
...
export class PoiRenderer {
     ...
     * @param imageTexture - Shared {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture},

...
import { assert, assertExists, LoggerManager } from "@orbitforge/orbitforge-utils";
...
import { type PoiTable } from "./PoiTableManager";

const logger = LoggerManager.instance.create("PoiManager");

/**
 * Interface for the {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture}s
 ...
 * {@link @orbitforge/orbitforge-datasource-protocol#PoiGeometry} objects
 * from the {@link @orbitforge/orbitforge-datasource-protocol#DecodedTile},
...
export class PoiManager {
    ...
    private static readonly m_missingPoiTableName = new Map<string, boolean>();
    private static readonly m_missingPoiName = new Map<string, boolean>();
    ...
    private readonly m_imageTextures = new Map<string, ImageTexture>();
    private readonly m_poiShieldGroups = new Map<string, number>();
     ...
     *                      {@link @orbitforge/orbitforge-datasource-protocol#PoiGeometry}
     ...
     *
     * @remarks
     * Creates an {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture}
    ...
    /**
     * Add an {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture} such that it
     * is available as a named entity for techniques in theme files.
     *
     * @param imageTexture - {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture}
    ...
    /**
     * Return the {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture}
     * registered under the specified name.
     *
     * @param name - Name of the {@link @orbitforge/orbitforge-datasource-protocol#ImageTexture}.
     */

...
export class PoiTable {
     ...
     */
    private readonly poiDict = new Map<string, number>();
 ...
 * can be defined in the {@link @orbitforge/orbitforge-datasource-protocol#Theme} sfile.
 */
export class PoiTableManager {
    private m_isLoading = false;
    private m_poiTables = new Map<string, PoiTable>();
    private readonly m_abortControllers = new Map<string, AbortController>();
     ...
     * {@link @orbitforge/orbitforge-datasource-protocol#Theme}.
     *
     * @remarks
     * Note that duplicate names of {@link PoiTable}s in the
     * {@link @orbitforge/orbitforge-datasource-protocol#Theme} will lead to inaccessible {@link PoiTable}s.
     *
     * @param poiTables - {@link @orbitforge/orbitforge-datasource-protocol#PoiTableRef[]}
     *                containing all {@link PoiTable}s to load.
     *
     * @returns Resolved once all the {@link PoiTable}s in
     *          the {@link @orbitforge/orbitforge-datasource-protocol#Theme} have been loaded.
     */
    async loadPoiTables(poiTables?: PoiTableRef[]): Promise<void> {
        const finished = new Promise<void>(resolve => {
            ...
            if (poiTables !== undefined) {
                ...
                const loadPromises = new Array<Promise<boolean>>();
     ...
     * are specified in the {@link @orbitforge/orbitforge-datasource-protocol#Theme}.
     *
     * @remarks

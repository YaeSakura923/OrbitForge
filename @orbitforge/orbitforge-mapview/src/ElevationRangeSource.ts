...
import { type TilingScheme } from "@orbitforge/orbitforge-geoutils";
...
export interface ElevationRangeSource {
    /**
     * Compute the elevation range for a given {@link @orbitforge/orbitforge-geoutils#TileKey}.
     ...
     * the same {@link @orbitforge/orbitforge-geoutils#TilingScheme}.
     */

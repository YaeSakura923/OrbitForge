...
import { BSplineSurface3d, BSplineSurface3dH, UVSelect } from "../bspline/bspline-surface";
...
import { DirectSpiral3d } from "../curve/spiral/direct-spiral3d";
import { IntegratedSpiral3d } from "../curve/spiral/integrated-spiral3d";
...
import { type Point3d, XYZ } from "../geometry3d/point3d-vector3d";
...
import { TopoSpiralTypeQueries } from "./bgfb-reader";
...
export class BGFBWriter {
    ...
    public writeCurvePrimitiveAsFBVariantGeometry(
        ...
        if (curvePrimitive instanceof LineSegment3d) {
            ...
            const typeCode = TopoSpiralTypeQueries.stringToTypeCode(
            ...
            const bearing1Radians = TransitionSpiral3d.radiusRadiusLengthToSweepRadians(
                radius0,
                radius1,
                nominalLength
            );
    ...
    public writeSolidPrimitiveAsFBVariantGeometry(solid: SolidPrimitive): number | undefined {
        ...
        if (solid instanceof Box) {
            ...
            const detailOffset = BGFBAccessors.TopoBoxDetail.createTopoBoxDetail(
                this.builder,
                originA.x,
                originA.y,
                originA.z,
            ...
            const carrierOffset = BGFBAccessors.TopoBox.createTopoBox(this.builder, detailOffset);
            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoBox,
                carrierOffset,
                0
            );
            ...
            const detailOffset = BGFBAccessors.TopoSphereDetail.createTopoSphereDetail(
                this.builder,
            ...
            const carrierOffset = BGFBAccessors.TopoSphere.createTopoSphere(
                this.builder,
                detailOffset
            );
            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoSphere,
                carrierOffset,
                0
            );
            ...
            const detailOffset = BGFBAccessors.TopoConeDetail.createTopoConeDetail(
                this.builder,
                centerA.x,
                centerA.y,
                centerA.z,
            ...
            const carrierOffset = BGFBAccessors.TopoCone.createTopoCone(this.builder, detailOffset);
            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoCone,
                carrierOffset,
                0
            );
            ...
            const detailOffset = BGFBAccessors.TopoTorusPipeDetail.createTopoTorusPipeDetail(
                this.builder,
                center.x,
                center.y,
                center.z,
            ...
            const carrierOffset = BGFBAccessors.TopoTorusPipe.createTopoTorusPipe(
                this.builder,
                detailOffset
            );
            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoTorusPipe,
                carrierOffset,
                0
            );
            ...
            // const carrierOffset = BGFBAccessors.TopoExtrusion.createTopoExtrusion(this.builder, contourOffset, sweepVectorOffset, solid.capped);

            // WOW -- the machine generated createTopoExtrusion expects an offset for the sweepVector, but then
            //  chokes trying to add it.
            BGFBAccessors.TopoExtrusion.startTopoExtrusion(this.builder);
            BGFBAccessors.TopoExtrusion.addBaseCurve(this.builder, baseCurveOffset);
            ...
            BGFBAccessors.TopoExtrusion.addExtrusionVector(this.builder, extrusionVectorOffset);
            BGFBAccessors.TopoExtrusion.addCapped(this.builder, solid.capped);
            const topoExtrusionOffset = BGFBAccessors.TopoExtrusion.endTopoExtrusion(this.builder);

            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoExtrusion,
                topoExtrusionOffset,
                0
            );
            ...
            // WOW -- the machine generated createTopoExtrusion expects an offset for the sweepVector, but then
            //  chokes trying to add it.
            BGFBAccessors.TopoRotationalSweep.startTopoRotationalSweep(this.builder);
            BGFBAccessors.TopoRotationalSweep.addBaseCurve(this.builder, baseCurveOffset);
            ...
            BGFBAccessors.TopoRotationalSweep.addAxis(this.builder, axisRayOffset);
            BGFBAccessors.TopoRotationalSweep.addSweepRadians(this.builder, sweepAngle.radians);
            BGFBAccessors.TopoRotationalSweep.addCapped(this.builder, solid.capped);
            const topoRotationalSweepOffset =
                BGFBAccessors.TopoRotationalSweep.endTopoRotationalSweep(this.builder);
            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoRotationalSweep,
                topoRotationalSweepOffset,
                0
            );
            ...
            const contoursVectorOffset = BGFBAccessors.TopoRuledSweep.createCurvesVector(
                this.builder,
                contourOffsets
            );
            const ruledSweepTable = BGFBAccessors.TopoRuledSweep.createTopoRuledSweep(
                this.builder,
            ...
            return BGFBAccessors.VariantGeometry.createVariantGeometry(
                this.builder,
                BGFBAccessors.VariantGeometryUnion.tagTopoRuledSweep,
                ruledSweepTable,
                0
            );
        }
    ...
    public writePolyfaceAuxChannelDataAsFBVariantGeometry(
        ...
        if (channelData instanceof AuxChannelData) {
            const valuesOffset = BGFBAccessors.PolyfaceAuxChannelData.createValuesVector(
                this.builder,
                channelData.values
            );
    ...
    public writePolyfaceAuxDataAsFBVariantGeometry(data: PolyfaceAuxData): number | undefined {
        if (data instanceof PolyfaceAuxData) {
            ...
            const channelOffsetsOffset = BGFBAccessors.PolyfaceAuxChannel.createDataVector(
                this.builder,
                channelOffsets
            );
    ...
    public writeGeometryQueryArrayAsFBVariantGeometry(
        ...
        if (Array.isArray(allGeometry)) {
            ...
            if (allOffsets.length > 0) {
                const membersOffset = BGFBAccessors.VectorOfVariantGeometry.createMembersVector(
                    this.builder,
                    allOffsets
                );
                const vectorOffset =

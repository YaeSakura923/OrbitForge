...
export namespace BGFBAccessors {
     ...
     * @constructor
     */
    export class TopoTorusPipeDetail {
        bb: flatbuffers.ByteBuffer | null = null;
         ...
         * @returns flatbuffers.Offset
         */
        static createTopoTorusPipeDetail(
            builder: flatbuffers.Builder,
            centerX: number,
            centerY: number,
            centerZ: number,
    ...
    export class TopoBox {
        ...
        static getRootAsTopoBox(bb: flatbuffers.ByteBuffer, obj?: TopoBox): TopoBox {
            return (obj || new TopoBox()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
        }
        ...
        detail(obj?: TopoBoxDetail): TopoBoxDetail | null {
            const offset = this.bb!.__offset(this.bb_pos, 4);
            return offset
                ? (obj || new TopoBoxDetail()).__init(this.bb_pos + offset, this.bb!)
                : null;
        }
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoBox(builder: flatbuffers.Builder) {
            builder.startObject(1);
        }
        ...
        static createTopoBox(
            builder: flatbuffers.Builder,
            detailOffset: flatbuffers.Offset
        ): flatbuffers.Offset {
            TopoBox.startTopoBox(builder);
            TopoBox.addDetail(builder, detailOffset);
            return TopoBox.endTopoBox(builder);
        }
    }
    /**
     * @constructor
     */
    export class TopoSphere {
        bb: flatbuffers.ByteBuffer | null = null;
        ...
        static getRootAsTopoSphere(bb: flatbuffers.ByteBuffer, obj?: TopoSphere): TopoSphere {
            return (obj || new TopoSphere()).__init(
                bb.readInt32(bb.position()) + bb.position(),
                bb
            );
        }
         ...
         * @returns TopoSphere
         */
        static getSizePrefixedRootAsTopoSphere(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoSphere
        ): TopoSphere {
            bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        ...
        detail(obj?: TopoSphereDetail): TopoSphereDetail | null {
            const offset = this.bb!.__offset(this.bb_pos, 4);
            return offset
                ? (obj || new TopoSphereDetail()).__init(this.bb_pos + offset, this.bb!)
                : null;
        }
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoSphere(builder: flatbuffers.Builder) {
            builder.startObject(1);
        }
        ...
        static createTopoSphere(
            builder: flatbuffers.Builder,
            detailOffset: flatbuffers.Offset
        ): flatbuffers.Offset {
            TopoSphere.startTopoSphere(builder);
            TopoSphere.addDetail(builder, detailOffset);
            return TopoSphere.endTopoSphere(builder);
        }
    }
    /**
     * @constructor
     */
    export class TopoCone {
        bb: flatbuffers.ByteBuffer | null = null;
        ...
        static getRootAsTopoCone(bb: flatbuffers.ByteBuffer, obj?: TopoCone): TopoCone {
            return (obj || new TopoCone()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
        }
        ...
        detail(obj?: TopoConeDetail): TopoConeDetail | null {
            const offset = this.bb!.__offset(this.bb_pos, 4);
            return offset
                ? (obj || new TopoConeDetail()).__init(this.bb_pos + offset, this.bb!)
                : null;
        }
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoCone(builder: flatbuffers.Builder) {
            builder.startObject(1);
        }
        ...
        static createTopoCone(
            builder: flatbuffers.Builder,
            detailOffset: flatbuffers.Offset
        ): flatbuffers.Offset {
            TopoCone.startTopoCone(builder);
            TopoCone.addDetail(builder, detailOffset);
            return TopoCone.endTopoCone(builder);
        }
    }
    /**
     * @constructor
     */
    export class TopoTorusPipe {
        bb: flatbuffers.ByteBuffer | null = null;
         ...
         * @returns TopoTorusPipe
         */
        static getRootAsTopoTorusPipe(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoTorusPipe
        ): TopoTorusPipe {
            return (obj || new TopoTorusPipe()).__init(
                bb.readInt32(bb.position()) + bb.position(),
                bb
            );
        }
         ...
         * @returns TopoTorusPipe
         */
        static getSizePrefixedRootAsTopoTorusPipe(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoTorusPipe
        ): TopoTorusPipe {
            bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
        ...
        detail(obj?: TopoTorusPipeDetail): TopoTorusPipeDetail | null {
            const offset = this.bb!.__offset(this.bb_pos, 4);
            return offset
                ? (obj || new TopoTorusPipeDetail()).__init(this.bb_pos + offset, this.bb!)
                : null;
        }
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoTorusPipe(builder: flatbuffers.Builder) {
            builder.startObject(1);
        }
        ...
        static createTopoTorusPipe(
            builder: flatbuffers.Builder,
            detailOffset: flatbuffers.Offset
        ): flatbuffers.Offset {
            TopoTorusPipe.startTopoTorusPipe(builder);
            TopoTorusPipe.addDetail(builder, detailOffset);
            return TopoTorusPipe.endTopoTorusPipe(builder);
        }
    }
    /**
     * @constructor
     */
    export class TopoExtrusion {
        bb: flatbuffers.ByteBuffer | null = null;
         ...
         * @returns TopoExtrusion
         */
        static getRootAsTopoExtrusion(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoExtrusion
        ): TopoExtrusion {
            return (obj || new TopoExtrusion()).__init(
                bb.readInt32(bb.position()) + bb.position(),
                bb
            );
        }
         ...
         * @returns TopoExtrusion
         */
        static getSizePrefixedRootAsTopoExtrusion(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoExtrusion
        ): TopoExtrusion {
            bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoExtrusion(builder: flatbuffers.Builder) {
            builder.startObject(3);
        }
        ...
        static createTopoExtrusion(
            builder: flatbuffers.Builder,
            baseCurveOffset: flatbuffers.Offset,
            extrusionVectorOffset: flatbuffers.Offset,
            capped: boolean
        ): flatbuffers.Offset {
            TopoExtrusion.startTopoExtrusion(builder);
            TopoExtrusion.addBaseCurve(builder, baseCurveOffset);
            TopoExtrusion.addExtrusionVector(builder, extrusionVectorOffset);
            TopoExtrusion.addCapped(builder, capped);
            return TopoExtrusion.endTopoExtrusion(builder);
        }
    }
    /**
     * @constructor
     */
    export class TopoRotationalSweep {
        bb: flatbuffers.ByteBuffer | null = null;
         ...
         * @returns TopoRotationalSweep
         */
        static getRootAsTopoRotationalSweep(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoRotationalSweep
        ): TopoRotationalSweep {
            return (obj || new TopoRotationalSweep()).__init(
                bb.readInt32(bb.position()) + bb.position(),
                bb
            );
        }
         ...
         * @returns TopoRotationalSweep
         */
        static getSizePrefixedRootAsTopoRotationalSweep(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoRotationalSweep
        ): TopoRotationalSweep {
            bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoRotationalSweep(builder: flatbuffers.Builder) {
            builder.startObject(5);
        }
        ...
        static createTopoRotationalSweep(
            builder: flatbuffers.Builder,
            baseCurveOffset: flatbuffers.Offset,
            ...
            TopoRotationalSweep.startTopoRotationalSweep(builder);
            TopoRotationalSweep.addBaseCurve(builder, baseCurveOffset);
            TopoRotationalSweep.addAxis(builder, axisOffset);
            TopoRotationalSweep.addSweepRadians(builder, sweepRadians);
            TopoRotationalSweep.addNumVRules(builder, numVRules);
            TopoRotationalSweep.addCapped(builder, capped);
            return TopoRotationalSweep.endTopoRotationalSweep(builder);
        }
    }
    /**
     * @constructor
     */
    export class TopoRuledSweep {
        bb: flatbuffers.ByteBuffer | null = null;
         ...
         * @returns TopoRuledSweep
         */
        static getRootAsTopoRuledSweep(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoRuledSweep
        ): TopoRuledSweep {
            return (obj || new TopoRuledSweep()).__init(
                bb.readInt32(bb.position()) + bb.position(),
                bb
            );
        }
         ...
         * @returns TopoRuledSweep
         */
        static getSizePrefixedRootAsTopoRuledSweep(
            bb: flatbuffers.ByteBuffer,
            obj?: TopoRuledSweep
        ): TopoRuledSweep {
            bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
         ...
         * @param flatbuffers.Builder builder
         */
        static startTopoRuledSweep(builder: flatbuffers.Builder) {
            builder.startObject(2);
        }
        ...
        static createTopoRuledSweep(
            builder: flatbuffers.Builder,
            curvesOffset: flatbuffers.Offset,
            capped: boolean
        ): flatbuffers.Offset {
            TopoRuledSweep.startTopoRuledSweep(builder);
            TopoRuledSweep.addCurves(builder, curvesOffset);
            TopoRuledSweep.addCapped(builder, capped);
            return TopoRuledSweep.endTopoRuledSweep(builder);
        }
    }
    /**
     * @constructor
    ...
    export class TransitionSpiral {
        ...
        detail(obj?: TransitionSpiralDetail): TransitionSpiralDetail | null {
            const offset = this.bb!.__offset(this.bb_pos, 4);
            return offset
                ? (obj || new TransitionSpiralDetail()).__init(this.bb_pos + offset, this.bb!)
                : null;
        }
        ...
        directDetail(obj?: DirectSpiralDetail): DirectSpiralDetail | null {
            const offset = this.bb!.__offset(this.bb_pos, 8);
            return offset
                ? (obj || new DirectSpiralDetail()).__init(this.bb_pos + offset, this.bb!)
                : null;
        }

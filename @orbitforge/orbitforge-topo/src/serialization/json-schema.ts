...
import { BSplineWrapMode } from "../bspline/knot-vector";
import { Arc3d } from "../curve/arc3d";
import { CoordinateXYZ } from "../curve/coordinate-xyz";
import { BagOfCurves, CurveCollection } from "../curve/curve-collection";
import { type AnyGeometryQuery, GeometryQuery } from "../curve/geometry-query";
...
import { type AngleProps, type AngleSweepProps, AxisOrder, Geometry } from "../geometry";
...
import { Point3d, Vector3d, XYZ } from "../geometry3d/point3d-vector3d";
import { Ray3d } from "../geometry3d/ray3d";
import { Segment1d } from "../geometry3d/segment1d";
import { Transform } from "../geometry3d/transform";
import { type XYProps, type XYZProps } from "../geometry3d/xyz-props";
import { type YawPitchRollProps, YawPitchRollAngles } from "../geometry3d/yaw-pitch-roll-angles";
    ...
    export class Reader {
            ...
            if (data && Array.isArray(data)) {
                for (const c of data) {
                    ...
                    if (
                        ...
                        (g.geometryCategory === "curveCollection" ||
                            g.geometryCategory === "curvePrimitive")
                    ) {
        ...
        public static parseLinearSweep(json?: any): LinearSweep | undefined {
            ...
            if (
                ...
                contour.geometryCategory === "curveCollection" &&
                capped !== undefined &&
                extrusionVector
            ) {
        ...
        public static parseBox(json?: BoxProps): Box | undefined {
            ...
            if (
                ...
                return Box.createTopoBoxWithAxes(
                    origin,
                    axes,
                    topOrigin,
                    baseX,
    ...
    export class Writer extends GeometryHandler {
        ...
        private handlePolyfaceAuxData(auxData: PolyfaceAuxData, pf: IndexedPolyface): any {
            ...
            for (const inChannel of auxData.channels) {
                const outChannel: Record<string, any> = {};

...
import { IndexedXYZCollectionInterval } from "../geometry3d/indexed-collection-interval";
...
import { TriangleCandidate } from "./triangle-candidate";
...
export class GreedyTriangulationBetweenLineStrings {
    private readonly _vector1: Vector3d;
    ...
    private readonly _turnRadians: number;
    ...
    private readonly _xyzA: Point3d;
    private readonly _xyzB: Point3d;
    private readonly _forwardA: Vector3d;
    private readonly _forwardB: Vector3d;
    private readonly _crossA: Vector3d;
    private readonly _crossB: Vector3d;
    /**

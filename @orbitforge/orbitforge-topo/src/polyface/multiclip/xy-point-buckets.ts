...
export class XYIndexGrid<T> {
    ...
    private readonly _data: Array<Array<OptionalArray<T>>>; // _indices[j][i][k] = index k value in row j block i
...
export class XYPointBuckets {
    private readonly _points: IndexedXYZCollection;
    private readonly _buckets: XYIndexGrid<number>;

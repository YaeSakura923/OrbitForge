...
import { type PolygonLocation, Geometry } from "../geometry";
...
import { PolygonLocationDetail, PolygonOps } from "../geometry3d/polygon-ops";
...
export class TriangularFacetLocationDetail implements FacetLocationDetail {
    ...
    private readonly _detail: TriangleLocationDetail;

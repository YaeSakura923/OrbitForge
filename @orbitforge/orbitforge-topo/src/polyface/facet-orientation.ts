...
import { type IndexedEdgeMatcher, SortableEdge } from "./indexed-edge-matcher";
import { type IndexedPolyface, type PolyfaceVisitor } from "./polyface";
...
export class FacetOrientationFixup {
    private readonly _edges: IndexedEdgeMatcher;
    private readonly _edgeToPartnerEdge: number[];
    private readonly _edgeToEdgeInComponent: number[];
    private _facetToFirstEdgeInComponent: number[];
    private _facetOrientation: number[];
    private readonly _components: OrientedComponentData[];
    private readonly _visitor: PolyfaceVisitor;
    private readonly _mesh: IndexedPolyface;
    ...
    private readonly _workArray: number[] = [];

...
import { HSVColor, HSVConstants } from "./hsv-color";
...
export class ColorDef {
    ...
    public static fromHSV(hsv: HSVColor, transparency = 0): ColorDef {
        ...
        const t =
            0xff & Math.floor(dvalue * (1.0 - dsaturation * (1.0 - hueFractpart)) * 255.0 + 0.5);

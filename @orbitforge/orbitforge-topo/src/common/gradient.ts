...
import {
    type ThematicGradientSettingsProps,
    ThematicGradientColorScheme,
    ThematicGradientMode,
    ThematicGradientSettings
} from "./thematic-display";
...
export namespace Gradient {
    ...
    export class Symb {
        ...
        public static compareSymb(lhs: Gradient.Symb, rhs: Gradient.Symb): number {
            ...
            if (lhs.thematicSettings !== rhs.thematicSettings) {
                if (undefined === lhs.thematicSettings) return -1;
                    ...
                    if (thematicCompareResult !== 0) return thematicCompareResult;
                }
            }
            return 0;
        }
        ...
        public get isOutlined(): boolean {
            return (this.flags & Flags.Outline) !== 0;
        }
        ...
        public getThematicImageForRenderer(maxDimension: number): ImageBuffer {
            ...
            const dimension =
                ThematicGradientMode.Smooth === settings.mode ? maxDimension : stepCount;

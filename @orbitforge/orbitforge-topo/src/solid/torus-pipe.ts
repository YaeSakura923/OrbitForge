...
export class TorusPipe extends SolidPrimitive implements UVSurface, UVSurfaceIsoParametricDistance {
    ...
    private readonly _radiusA: number; // radius of (large) circle in xy plane
    private readonly _radiusB: number; // radius of (small) circle in xz plane.
    private readonly _sweep: Angle;
    ...
    public static createTopoTorusPipe(
        center: Point3d,
        vectorX: Vector3d,
        vectorY: Vector3d,
        majorRadius: number,

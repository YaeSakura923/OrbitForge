...
export class Sphere extends SolidPrimitive implements UVSurface {
    ...
    private readonly _localToWorld: Transform; // unit sphere maps to world through the transform0 part of this map.
    private readonly _latitudeSweep: AngleSweep;
    ...
    public static createTopoSphere(
        center: Point3d,
        vectorX: Vector3d,
        vectorZ: Vector3d,
        radiusXY: number,

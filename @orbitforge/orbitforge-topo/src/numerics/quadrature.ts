...
export class Quadrature {
    ...
    public static setupGauss1(
        ...
        return Quadrature.mapWeights(
            xA,
            xB - xA,
            Quadrature.gaussX1Interval01,
            Quadrature.gaussW1Interval01,
            xMapped,
            wMapped
        );
    }
    ...
    */
    ...
    public static setupGauss4(
        ...
        return Quadrature.mapWeights(
            xA,
            xB - xA,
            Quadrature.gaussX4Interval01,
            Quadrature.gaussW4Interval01,
            xMapped,
            wMapped
        );
        /*  // exact formulas for interval xA..xB:
...
export class GaussMapper {
    ...
    public constructor(numGaussPoints: number) {
        ...
        if (numGaussPoints > 5 || numGaussPoints < 1) numGaussPoints = 5;
        switch (numGaussPoints) {
            case 1:
                this.mapXAndWFunction = (xA, xB, xMapped, wMapped) =>
                    Quadrature.setupGauss1(xA, xB, xMapped, wMapped);
                break;
            case 2:
                this.mapXAndWFunction = (xA, xB, xMapped, wMapped) =>
                    Quadrature.setupGauss2(xA, xB, xMapped, wMapped);
                break;
            case 3:
                this.mapXAndWFunction = (xA, xB, xMapped, wMapped) =>
                    Quadrature.setupGauss3(xA, xB, xMapped, wMapped);
                break;
            case 4:
                this.mapXAndWFunction = (xA, xB, xMapped, wMapped) =>
                    Quadrature.setupGauss4(xA, xB, xMapped, wMapped);
                break;
            default:
                this.mapXAndWFunction = (xA, xB, xMapped, wMapped) =>

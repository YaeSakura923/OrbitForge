...
import { PascalCoefficients } from "./pascal-coefficients";
import {
    type Degree3PowerPolynomial,
    type Degree4PowerPolynomial,
    AnalyticRoots,
...
export class Order4Bezier extends BezierCoffs {
    ...
    public evaluate(u: number): number {
        ...
        return (
            this.coffs[0] * v3 +
            u * (3.0 * this.coffs[1] * v2 + u * (3.0 * this.coffs[2] * v1 + u * this.coffs[3]))
        );
    }

...
export class Point4d extends Plane3d implements BeJSONFunctions {
    ...
    public set(x: number = 0, y: number = 0, z: number = 0, w: number = 0): this {
        this.xyzw[0] = x;
        this.xyzw[1] = y;
        this.xyzw[2] = z;
        this.xyzw[3] = w;
    ...
    public setFrom(other: Point4d): this {
    ...
    public altitude(point: Point3d): number {
        return (
            this.xyzw[0] * point.x + this.xyzw[1] * point.y + this.xyzw[2] * point.z + this.xyzw[3]
        );
    }
    ...
    public static interpolateQuaternions(
        ...
        if (fractionParameter === 0.0) {
            result = quaternion0;
            return result;
        }
        if (fractionParameter === 1.0) {
            result = quaternion1;
            return result;
        }

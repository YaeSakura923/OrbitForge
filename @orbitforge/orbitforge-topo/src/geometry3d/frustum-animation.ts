...
export class SmoothTransformBetweenFrusta {
    // raw frusta:
    private readonly _localCornerA: Point3d[];
    private readonly _localCornerB: Point3d[];

    private readonly _localToWorldA: Transform;
    private readonly _localToWorldB: Transform;
    ...
    private readonly _rotationAxis: Vector3d;
    private readonly _rotationAngle: Angle;

...
export class OrderedRotationAngles {
    /** rotation around x */
    private readonly _x: Angle;
    /** rotation around y */
    private readonly _y: Angle;
    /** rotation around z */
    private readonly _z: Angle;
    ...
    public static createFromMatrix3d(
        ...
        let m12 = matrix.coffs[1];
        let m13 = matrix.coffs[2];
        let m21 = matrix.coffs[3];
        let m22 = matrix.coffs[4];
        let m23 = matrix.coffs[5];
        let m31 = matrix.coffs[6];
        let m32 = matrix.coffs[7];
        let m33 = matrix.coffs[8];

...
export class TriangleLocationDetail {
    ...
    public get classify(): PolygonLocation {
        ...
        if (this.isInsideOrOn) {
            ...
            if (numZero === 2) return PolygonLocation.OnPolygonVertex;
            if (numZero === 1) return PolygonLocation.OnPolygonEdgeInterior;
...
export class BarycentricTriangle {
    ...
    public closestPoint(
        ...
        if (BarycentricTriangle.isInsideTriangle(b0, b1, b2)) {
            ...
            edgeParam =
                1 - b[BarycentricTriangle.edgeOppositeVertexIndexToStartVertexIndex(edgeIndex)];
        ...
        return {
            closestEdgeIndex:
                edgeIndex < 0
                    ? -1
                    : BarycentricTriangle.edgeOppositeVertexIndexToStartVertexIndex(edgeIndex),

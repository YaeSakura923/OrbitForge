...
import { type GrowableXYZArray } from "./growable-xyz-array";
import {
    type IndexedReadWriteXYZCollection,
    type IndexedXYZCollection
} from "./indexed-xyz-collection";
...
export class PolylineCompressionContext {
    ...
    private readonly _source: IndexedXYZCollection;

    private readonly _dest: IndexedReadWriteXYZCollection;

    /** Squared tolerance for equal point. */
    private readonly _toleranceSquared: number;
    ...
    private static readonly _vector01: Vector3d = Vector3d.create();
    private static readonly _vectorQ: Vector3d = Vector3d.create();
    /**
    ...
    private indexOfMaxDeviation(index0: number, index1: number): number | undefined {
        ...
        for (let index = index0 + 1; index < index1; index++) {
            ...
            if (numerator <= 0) {
                ...
                distanceSquared =
                    PolylineCompressionContext._vectorQ.magnitudeSquared() - denominator * s * s;
            }

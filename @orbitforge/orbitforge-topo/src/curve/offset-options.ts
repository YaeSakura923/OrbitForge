...
export class JointOptions {
    ...
    public static create(leftOffsetDistanceOrOptions: number | JointOptions): JointOptions {
        if (leftOffsetDistanceOrOptions instanceof JointOptions) return leftOffsetDistanceOrOptions;
    ...
    public numChamferPoints(theta: Angle): number {
        ...
        const stepDegrees = Geometry.clamp(
            this.maxChamferTurnDegrees,
            minStepDegreesClamp,
            maxStepDegreesClamp
        );
...
export class OffsetOptions {
    ...
    constructor(offsetDistanceOrOptions: number | JointOptions, strokeOptions?: StrokeOptions) {
        ...
        this.strokeOptions =
            strokeOptions !== undefined ? strokeOptions : StrokeOptions.createForCurves();
    }
    ...
    public static create(
        ...
        if (offsetDistanceOrOptions instanceof OffsetOptions) return offsetDistanceOrOptions;
    ...
    public static getOffsetDistance(
        ...
        if (typeof offsetDistanceOrOptions === "number") return offsetDistanceOrOptions;

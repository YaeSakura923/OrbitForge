    ...
    implements IStrokeHandler
{
    ...
    private readonly _plane: PlaneAltitudeEvaluator;
    private readonly _intersections: CurveLocationDetail[];
    ...
    private announceSolutionFraction(fraction: number) {
        ...
        if (curve) {
            ...
            this._intersections.push(
                CurveLocationDetail.createCurveFractionPoint(curve, fraction, this._ray.origin)
            );
        }
    }

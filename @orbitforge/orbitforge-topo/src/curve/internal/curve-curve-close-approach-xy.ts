...
export class CurveCurveCloseApproachXY extends RecurseToCurvesGeometryHandler {
    ...
    private recordPointWithLocalFractions(
        ...
        if (isInterval) {
            ...
            if (d2 > this._maxDistanceSquared) return;
    ...
    private static segmentSegmentBoundedApproach(
        ...
        if (hab0 * hab0 <= maxDistanceSquared * uu) {
            ...
            if (
                this.updatePointToSegmentDistance(
                    0,
                    b0,
                    a0,
                    a1,
        ...
        if (closestApproach.detailA.a > maxDistanceSquared) return undefined;
        if (reversed) closestApproach.swapDetails();
    ...
    private testAndRecordProjection(
        ...
        if (detail) {
            ...
            if (fB === detail.fraction) {
                // if fraction is within fB0 and fB1
    ...
    private dispatchCircularCircularOrdered(
        ...
        if (c > radiusA + radiusB + e) {
            // distance between circles is more than max distance
            return;
        }
                ...
                for (const rB of [-radiusB, radiusB]) {
                    ...
                    if (tangentDistance < e) {
                        ...
                        if (detailA) {
                            ...
                            if (detailB) this.captureDetailPair(detailA, detailB, reversed);
                        }
                    }
                }
            }

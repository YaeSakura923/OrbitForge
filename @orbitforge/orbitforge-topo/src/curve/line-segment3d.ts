...
import { Order2Bezier } from "../numerics/bezier-polynomials";
import { type VariantCurveExtendParameter, CurveExtendOptions } from "./curve-extend-mode";
import { CurveIntervalRole, CurveLocationDetail } from "./curve-location-detail";
...
export class LineSegment3d extends CurvePrimitive implements BeJSONFunctions {
    ...
    public cloneTransformed(transform: Transform): LineSegment3d {
    ...
    public isInPlane(plane: PlaneAltitudeEvaluator): boolean {
        return (
            Geometry.isSmallMetricDistance(plane.altitude(this._point0)) &&
    ...
    public setFromJSON(json?: any) {
        if (!json) {
            ...
            // {startPoint:json point, endPoint:json point}

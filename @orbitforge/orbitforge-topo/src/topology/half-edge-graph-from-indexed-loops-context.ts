...
export class HalfEdgeGraphFromIndexedLoopsContext {
    ...
    private readonly _unmatchedEdges: Map<string, HalfEdge>;
    ...
    private readonly _halfEdgesAroundCurrentLoop: HalfEdge[];
    ...
    public insertLoop(
        ...
        if (n > 1) {
            ...
            let halfEdgeA =
                this._halfEdgesAroundCurrentLoop[this._halfEdgesAroundCurrentLoop.length - 1];

...
import {
    type HalfEdge,
    type HalfEdgeToBooleanFunction,
    type NodeToNumberFunction,
    HalfEdgeGraph,
    HalfEdgeMask
} from "./graph";
import { SignedDataSummary } from "./signed-data-summary";
import { XYParitySearchContext } from "./xy-parity-search-context";
...
export class HalfEdgeMaskTester {
    private readonly _targetMask: HalfEdgeMask;
    private readonly _targetValue: boolean;
    /**
     *

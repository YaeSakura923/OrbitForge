...
export class HalfEdgePositionDetail {
     ...
     */
    public resetAsFace(node?: HalfEdge, xyz?: XYAndZ): this {
     ...
     */
    public resetAsUndefinedWithTag(dTag: number): this {
        this._topo = HalfEdgeTopo.None;
        this._dTag = 0;
        this._iTag = 0;
        this._dTag = dTag;
     ...
     */
    public resetAtEdgeAndFraction(node: HalfEdge, edgeFraction: number): this {
     ...
     */
    public resetAsVertex(node: HalfEdge): this {

...
import { type HalfEdge, type HalfEdgeGraph, HalfEdgeMask } from "./graph";
import { MarkedEdgeSet } from "./half-edge-mark-set";
import { PointSearchContext, RayClassification } from "./half-edge-point-in-graph-search";
...
export class InsertAndRetriangulateContext {
    ...
    private readonly _edgeSet: MarkedEdgeSet;

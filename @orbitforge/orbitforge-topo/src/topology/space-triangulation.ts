...
export class SpacePolygonTriangulation {
     ...
     */
    public static spaceQuadDiagonalAspectRatio(
        point0: Point3d,
        point1: Point3d,
        point2: Point3d,
        point3: Point3d
    ...
    public static triangulateGreedyEarCut(
        points: Point3d[],
    ...
    private static triangulateSimplestSpaceLoopGo(
        ...
        if (n === 4) {
            ...
            if (d02 > d13) {
                announceLoopAndTriangles(points, [
     ...
     */
    public static triangulateSimplestSpaceLoop(

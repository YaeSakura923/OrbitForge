...
vec4 getSplat(vec2 meshPos, vec3 worldPos, vec2 scale, vec3 covA, vec3 covB, mat4 worldMatrix, mat4 viewMatrix, mat4 projectionMatrix)
{
...
void main () {
    ...
    gl_Position = getSplat(vPosition, worldPos.xyz, vec2(1.,1.), covA, covB, modelMatrix, viewMatrix, projectionMatrix);

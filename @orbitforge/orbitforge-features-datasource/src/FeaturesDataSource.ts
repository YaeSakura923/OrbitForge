...
import { GeoBox, GeoCoordinates } from "@orbitforge/orbitforge-geoutils";
import { type MapView } from "@orbitforge/orbitforge-mapview";
import { LoggerManager } from "@orbitforge/orbitforge-utils";
import {
    type GeoJsonDataProviderOptions,
    type VectorTileDataSourceParameters,
    GeoJsonDataProvider,
    RBushTiler,
    VectorTileDataSource
} from "@orbitforge/orbitforge-vectortile-datasource";

import { type MapViewFeature } from "./Features";
...
export class FeaturesDataSource extends VectorTileDataSource {
    ...
    constructor(options?: FeatureDataSourceOptions) {
        super({
            ...
            ...options,
            dataProvider: new GeoJsonDataProvider(NAME, DEFAULT_GEOJSON, {
                ...options,
                tiler: options?.tiler || new RBushTiler()
            }),

# @orbitforge/orbitforge-kriging-gl
...
```bash
npm install @orbitforge/orbitforge-kriging-gl
```

## Modern API Usage

```javascript
import { KrigingSurface } from '@orbitforge/orbitforge-kriging-gl';
...
```javascript
import { train, predict, generate } from '@orbitforge/orbitforge-kriging-gl';

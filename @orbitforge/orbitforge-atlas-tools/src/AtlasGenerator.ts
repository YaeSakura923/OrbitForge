...
import { type Color, type ImageDecoder, type ImageEncoder, ImageFactory } from "./ImageFactory";
import {
...
import { type Logger, getLogger, LogLevel } from "./Logger";
...
function getBlendOperationByName(blendModeName: string): BlendOperation {
    const blendOperations = new Map<string, BlendOperation>([
